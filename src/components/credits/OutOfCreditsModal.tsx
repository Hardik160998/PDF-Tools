...
export default function OutOfCreditsModal({
 ...
 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight mb-3"
 >
 {isGuest ? (
 <>
 You&apos;ve Used All{""}
 ...
 className="w-full inline-flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white text-sm font-bold uppercase tracking-wider py-3.5 rounded-2xl shadow-lg shadow-blue-500/20 transition-all hover:scale-[1.02]"
 onClick={onClose}
 >
 <UserPlus size={16} />
 ...
 <Link
 href="/premium-plans"
 className="w-full inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white text-sm font-bold uppercase tracking-wider py-3.5 rounded-2xl shadow-lg shadow-orange-500/20 transition-all hover:scale-[1.02]"
 onClick={onClose}
 >
