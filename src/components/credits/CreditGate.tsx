...
export default function CreditGate({
 ...
 <span className="text-xs font-bold uppercase tracking-wider text-red-600 dark:text-red-400 group-hover:translate-x-1 transition-transform inline-flex items-center gap-1 bg-white dark:bg-slate-900 border border-red-100 dark:border-red-900/50 px-4 py-1.5 rounded-full shadow-sm">
