    ...
    >
      ...
      <div className="relative w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-200/50 dark:border-slate-800 overflow-hidden animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="p-8 text-center">
          ...
          <div className="relative inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-gradient-to-tr from-amber-400 to-orange-500 text-slate-950 shadow-xl shadow-amber-500/25 mb-6 mx-auto animate-bounce" style={{ animationDuration: '2.5s' }}>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mb-6 font-medium">
            Welcome to <span className="font-extrabold text-amber-500">SmartPDFs Plus</span>. Your premium account is now active.
          </p>
          ...
          <div className="mb-8 p-5 rounded-2xl bg-slate-50 dark:bg-slate-950/50 border border-slate-100 dark:border-slate-800/80 text-left space-y-3">
            <div className="flex justify-between items-center text-xs">
              <span className="font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider">Plan Activated</span>
              <span className="font-black text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-950/30 border border-indigo-100 dark:border-indigo-900/30 px-3 py-1 rounded-full text-[10px] uppercase tracking-wider">
                {planName}
              </span>
            </div>
            <div className="h-px bg-slate-200/60 dark:bg-slate-800/60" />
            <div className="space-y-1.5">
              <span className="block text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider">Razorpay Payment ID</span>
          ...
          <div className="p-4 rounded-2xl bg-emerald-50/50 dark:bg-emerald-950/10 border border-emerald-100/50 dark:border-emerald-900/20 mb-8">
            <p className="text-xs font-bold text-emerald-700 dark:text-emerald-400 leading-relaxed">
              🎉 All premium tools, unlimited batch sizes, and 1GB file processing speed are now unlocked!
            </p>
          </div>
          ...
          <button
            onClick={onClose}
            className="w-full inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-500 via-orange-500 to-rose-500 hover:from-amber-600 hover:to-rose-600 text-slate-950 text-sm font-black uppercase tracking-wider py-4 rounded-2xl shadow-lg shadow-orange-500/25 transition-all hover:scale-[1.02] cursor-pointer"
          >
            Continue to Profile
