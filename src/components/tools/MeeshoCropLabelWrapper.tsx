...
export function MeeshoCropLabelSkeleton() {
  return (
...
const MeeshoCropLabelClient = dynamic(() => import("./MeeshoCropLabel"), {
  ssr: false,
  loading: () => <MeeshoCropLabelSkeleton />,
});

export default function MeeshoCropLabelWrapper({ id }: { id: string }) {
  return <MeeshoCropLabelClient id={id} />;
}
