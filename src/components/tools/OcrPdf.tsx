...
export default function OcrPdf({ id: _id }: { id: string }) {
 ...
 <span className="text-[11px] font-medium text-slate-400 uppercase tracking-widest block">Recognition Language</span>
 ...
 <span className="text-[11px] font-medium text-slate-400 uppercase tracking-widest">Job Status</span>
 </div>
 ...
 <button onClick={reset} className="w-full py-3 bg-slate-100 text-slate-500 rounded-xl text-[11px] font-medium uppercase tracking-widest hover:bg-slate-200 transition-all">Start Over</button>
 </div>
 )}
 </div>
 </div>
