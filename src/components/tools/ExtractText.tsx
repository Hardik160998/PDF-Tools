...
export default function ExtractText({ id: toolId }: { id: string }) {
 ...
 <h3 className="hidden lg:block text-xl font-bold text-slate-900 dark:text-white uppercase tracking-tighter">Export Options</h3>
 ...
 <span className="text-[11px] font-medium text-slate-400 uppercase tracking-widest block">Output Format</span>
 ...
 className={`flex items-center justify-center gap-2 py-2.5 rounded-xl text-xs font-medium transition-all ${mode === 'text' ? 'bg-white dark:bg-slate-800 text-blue-500 shadow-sm' : 'text-slate-400 hover:text-slate-600'}`}
 >
 <FileText size={14} /> TEXT
 </button>
 <button 
 onClick={() => setMode('xml')} 
 className={`flex items-center justify-center gap-2 py-2.5 rounded-xl text-xs font-medium transition-all ${mode === 'xml' ? 'bg-white dark:bg-slate-800 text-blue-500 shadow-sm' : 'text-slate-400 hover:text-slate-600'}`}
 >
 ...
 <div className="p-2 rounded-lg bg-blue-50 dark:bg-blue-500/10 shadow-sm text-blue-500 flex items-center justify-center">
 <Terminal size={14} />
 </div>
 <span className="text-[11px] font-medium text-slate-400 uppercase tracking-widest">Parser Status</span>
 </div>
 ...
 <p className="text-[10px] text-center text-slate-400 font-medium uppercase tracking-widest mt-4">Local Extraction Engine v2.0</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="bg-white dark:bg-slate-800 rounded-[2.5rem] border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-2xl transition-shadow duration-300 p-6 sm:p-12 min-h-[600px] flex flex-col relative overflow-hidden">
 ...
 onDrop={onDrop}>
 <div className="p-6 bg-white dark:bg-slate-800 rounded-3xl shadow-sm hover:shadow-xl transition-shadow duration-300 text-blue-500 mb-6 group-hover:scale-110 transition-transform relative z-10">
 <Upload size={32} />
 </div>
