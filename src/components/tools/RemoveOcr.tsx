        ...
        <div className="max-w-3xl mx-auto py-6 sm:py-10 px-4">
            <div className="bg-white dark:bg-slate-800 rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-12 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-2xl transition-shadow duration-300 space-y-6 sm:space-y-10 overflow-hidden">
                ...
                <div className="text-center space-y-3 sm:space-y-4">
                    ...
                    <h2 className="text-2xl sm:text-4xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">Remove OCR</h2>
                ...
                <div className="space-y-5">
                    ...
                    {!file ? (
                        ...
                        >
                            ...
                            <div className="text-center">
                                <h3 className="text-2xl sm:text-3xl font-black text-slate-800 dark:text-white mb-2 tracking-tight text-center">{dragging ? "Drop your PDF here!" : "Click or drag & drop PDF"}</h3>
                    ...
                    {pages.length > 0 && pages.some(p => p.status !== "pending") && (
                        <div className="grid grid-cols-4 sm:grid-cols-6 gap-2">
                            {pages.map(p => (
                                <div key={p.num} className={`rounded-xl border p-2 flex flex-col items-center gap-1.5 text-center transition-all ${p.status === "done" ? "border-green-200 bg-green-50 dark:bg-green-500/10 dark:border-green-500/20"
