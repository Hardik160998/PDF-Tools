...
import { 
 ...
 Zap, Shield, Sparkles, Lock, Smartphone, Rocket, PenLine
} from 'lucide-react';
...
export default function PdfEditor() {
            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl sm:rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-2xl transition-shadow duration-300 p-5 sm:p-10 min-h-[500px] flex flex-col relative overflow-hidden max-w-4xl mx-auto w-full">
              ...
              <div className="relative text-center space-y-4 mb-6">
                ...
                <p className="text-sm sm:text-base text-slate-500 dark:text-slate-400 font-medium max-w-md mx-auto leading-relaxed text-center">
                  Add text, images, and white-out directly in your browser.
                </p>
              </div>
 ...
 <p className="text-xl font-bold text-slate-900 dark:text-white uppercase tracking-widest">Processing Document...</p>
 </div>
 );
 }
 ...
 <a href={resultUrl!} download="edited.pdf" className="flex-1 py-4 sm:py-5 bg-pink-500 text-white rounded-2xl sm:rounded-3xl font-bold text-lg sm:text-xl uppercase tracking-widest shadow-xl hover:scale-105 transition-all flex items-center justify-center gap-3">
 ...
 <button onClick={() => setZoom(0.8)} className="ml-2 text-[9px] font-bold uppercase text-pink-500 hover:underline">Reset</button>
 </div>

 <button onClick={savePdf} className="px-4 sm:px-8 py-2.5 sm:py-3 bg-pink-500 text-white rounded-lg sm:rounded-xl font-bold text-xs sm:text-sm uppercase tracking-widest shadow-lg hover:scale-105 transition-all flex items-center gap-2">
 ...
 <span className="font-bold text-[10px] sm:text-sm uppercase tracking-widest text-slate-500">Page {currentPage + 1} / {pageImages.length}</span>
 ...
 <label className="text-[10px] font-bold uppercase tracking-widest text-slate-500">Default Text Color</label>
 <div className="flex items-center gap-4">
 ...
 <div className="space-y-3">
 <label className="text-[10px] font-bold uppercase tracking-widest text-slate-500">Default Font Size</label>
 ...
 <div className="text-right font-bold text-sm text-pink-500">{fontSize}px</div>
 </div>
 </div>
 </div>
 ...
 <span className="text-[10px] font-bold text-slate-300">P{el.page + 1}</span>
 </div>
 ))}
