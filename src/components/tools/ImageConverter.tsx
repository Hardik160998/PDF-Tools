...
export default function ImageConverter({ id: toolId }: { id: string }) {
 ...
 <div>
 <h3 className="text-3xl font-bold text-slate-900 dark:text-white uppercase tracking-widest leading-none mb-1">Success!</h3>
 ...
 <span className="text-white text-[11px] font-medium uppercase tracking-widest bg-white/20 px-3 py-1 rounded-full backdrop-blur-md">Result Image</span>
 </div>
 </div>
 ...
 <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform shadow-inner" style={{ color: ACCENT, backgroundColor: `${ACCENT}15` }}>
 <feat.icon size={28} />
 </div>
 <h5 className="text-xs font-bold uppercase tracking-widest text-slate-900 dark:text-white mb-3 leading-none">{feat.title}</h5>
