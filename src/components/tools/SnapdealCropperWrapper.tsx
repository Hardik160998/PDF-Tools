...
import { ShoppingBag, Upload, Zap, Shield, Sparkles, Lock, Trash2, Smartphone, Rocket } from "lucide-react";

const ACCENT = "#E40046";

export function SnapdealCropperSkeleton() {
  return (
...
const SnapdealCropperClient = dynamic(() => import("./SnapdealCropper"), {
  ssr: false,
  loading: () => <SnapdealCropperSkeleton />,
});

export default function SnapdealCropperWrapper({ id }: { id: string }) {
  return <SnapdealCropperClient id={id} />;
}
