            ...
            <div className="flex flex-col-reverse lg:flex-row-reverse gap-4 sm:gap-8 items-start">
                ...
                >
                    <div className="flex items-center justify-between mb-6">
                        <h3 className="text-xl font-bold text-slate-900 dark:text-white uppercase tracking-tighter mb-0">Settings</h3>
                        <button
                ...
                <div className="flex-1 w-full bg-white dark:bg-slate-800 rounded-3xl p-6 sm:p-12 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-2xl transition-shadow duration-300 text-center">
                    <div className="space-y-4 mb-10">
                        <div className="inline-flex p-4 rounded-2xl text-white shadow-lg" style={{ background: ACCENT }}><ShoppingBag size={32} /></div>
                        <h2 className="text-2xl sm:text-4xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">Snapdeal Label Cropper</h2>
                    ...
                    {!done ? (
                        <div className="space-y-6">
                            <div className="border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-2xl sm:rounded-3xl p-8 sm:p-16 hover:border-[#E40046] transition-all cursor-pointer bg-slate-50/50 dark:bg-slate-900/50"
                                onClick={() => {
                                    if (!isPremium && remaining <= 0) {
                                        setOutOfCreditsOpen(true);
                                        return;
                            ...
                            >
                                ...
                                <h3 className="text-2xl sm:text-3xl font-black text-slate-800 dark:text-white mb-2 tracking-tight text-center">Drop Snapdeal PDFs</h3>
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-3">{labelCount} Labels Extracted</h3>
