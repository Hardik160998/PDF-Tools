...
const MergeSplitLoader = () => (
 <div className="w-full bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-2xl p-6 sm:p-10 min-h-[500px] flex flex-col items-center justify-center relative overflow-hidden animate-pulse">
...
const MergeSplit = dynamic(() => import("./MergeSplit"), {
 ssr: false,
 loading: () => <MergeSplitLoader />,
});

export default function MergeSplitWrapper({ id }: { id: string }) {
 return <MergeSplit id={id} />;
}
