...
export default function OptimizePdf({ id }: { id: string }) {
 ...
 <span className="text-[11px] font-medium text-slate-400 uppercase tracking-widest">Target Profile</span>
 ...
 <span className={`text-[10px] font-bold px-2 py-0.5 rounded-md ${level === l.id ? 'bg-emerald-500 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-400'}`}>{l.printScore}</span>
 </div>
 ...
 <span className="text-[11px] font-medium text-slate-400 uppercase tracking-widest">Print Quality</span>
 </div>
 <p className="text-xs font-medium text-slate-700 dark:text-slate-200 uppercase tracking-tight text-left">
 ...
 <h4 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white uppercase tracking-widest truncate">{file.name}</h4>
 <div className="flex flex-wrap justify-center sm:justify-start gap-4 mt-2">
 <span className="text-[11px] font-medium uppercase tracking-widest text-slate-400 bg-white dark:bg-slate-800 px-3 py-1 rounded-full shadow-sm">{fmt(file.size)}</span>
 <span className="text-[11px] font-medium uppercase tracking-widest text-emerald-500 bg-emerald-50 dark:bg-emerald-500/10 px-3 py-1 rounded-full">{pageCount} Pages Loaded</span>
 </div>
 </div>
 ...
 <p className="text-[11px] font-medium text-slate-400 uppercase tracking-widest">Original Volume</p>
 ...
 <p className="text-[11px] font-medium text-emerald-600 uppercase tracking-widest">Optimized Volume</p>
 <p className={` text-lg sm:text-xl font-medium tracking-widest ${result.status === 'optimized' ? 'text-emerald-600' : 'text-slate-900 dark:text-white'}`}>{fmt(result.newSize)}</p>
 </div>
 </div>
 )}
 </div>
