...
import { Upload, Download, X, FileText, CheckCircle2, Loader2, Layers, Eye, EyeOff, Settings, ChevronDown, Plus, Lock, Trash2, Smartphone, Rocket, Zap, Shield, Sparkles } from "lucide-react";
