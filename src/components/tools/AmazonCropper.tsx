...
export default function AmazonCropper({ id }: { id: string }) {
 ...
 <h3 className="hidden lg:block text-xl font-bold text-slate-900 dark:text-white mb-6 uppercase tracking-tighter text-left">Settings</h3>
 ...
 <p className="text-sm sm:text-base text-slate-500 dark:text-slate-400 font-medium max-w-md mx-auto leading-relaxed">Extract shipping labels instantly. Invoices and extra pages are automatically removed.</p>
 </div>
 ...
 <h3 className="text-3xl font-bold text-slate-900 dark:text-white uppercase tracking-tighter">{labelCount} Labels Extracted</h3>
