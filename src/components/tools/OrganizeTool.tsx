...
export default function OrganizeTool({ id: _id }: { id: string }) {
 ...
 <h3 className="hidden lg:block text-xl font-bold text-slate-900 dark:text-white uppercase tracking-tighter">Tools</h3>
 <button onClick={resetAll} className="text-[11px] font-medium uppercase tracking-widest text-red-500 hover:text-red-600 transition-colors">Reset All</button>
 </div>
 
 <div className="space-y-6 text-left">
 {/* Batch Controls */}
 <div className="space-y-3">
 <span className="text-[11px] font-medium text-slate-400 uppercase tracking-widest">Global Actions</span>
 <div className="grid grid-cols-2 gap-2">
 <button onClick={rotateAll} disabled={pages.length === 0} className="flex flex-col items-center justify-center gap-2 py-4 rounded-xl text-[11px] font-medium uppercase tracking-widest text-slate-600 dark:text-slate-300 bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 hover:bg-slate-100 transition-colors disabled:opacity-50">
 <RefreshCw size={16} /> Rotate All
 </button>
 <button onClick={reverseOrder} disabled={pages.length === 0} className="flex flex-col items-center justify-center gap-2 py-4 rounded-xl text-[11px] font-medium uppercase tracking-widest text-slate-600 dark:text-slate-300 bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 hover:bg-slate-100 transition-colors disabled:opacity-50">
 ...
 <span className="text-[11px] font-medium text-slate-400 uppercase tracking-widest flex items-center gap-2">
 ...
 <button onClick={() => fileInputRef.current?.click()} className="w-full flex items-center justify-center gap-2 py-3 rounded-xl text-[11px] font-medium uppercase tracking-widest text-orange-600 bg-orange-50 border border-orange-100 hover:bg-orange-100 transition-colors mt-2">
 ...
 <h2 className="text-2xl sm:text-4xl font-black text-slate-900 dark:text-white uppercase tracking-tighter leading-tight">Organize PDF Pages</h2>
 {pages.length > 0 && <p className="text-sm sm:text-base text-slate-500 dark:text-slate-400 font-medium max-w-md mx-auto leading-relaxed">Drag and drop to reorder. Rotate or delete individual pages below.</p>}
 </div>
 ...
 <p className="text-[11px] text-slate-400 font-medium relative z-10 uppercase tracking-widest">Visual batch reorder & merge</p>
