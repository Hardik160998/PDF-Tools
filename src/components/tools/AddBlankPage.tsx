...
export default function AddBlankPage({ id: _id }: { id: string }) {
 ...
 <h3 className="hidden lg:block text-xl font-bold text-slate-900 dark:text-white mb-6 uppercase tracking-tighter text-left">Configuration</h3>
 
 <div className="space-y-6 text-left">
 {/* Position */}
 <div className="space-y-3">
 <span className="text-[11px] font-medium text-slate-400 uppercase tracking-widest">Insertion Point</span>
 ...
 <span className="text-[11px] font-medium text-slate-400 uppercase tracking-widest">Target Page</span>
 ...
 <span className="font-medium text-slate-900 dark:text-white text-xs uppercase tracking-tight">{afterPage} <span className="text-[10px] text-slate-400">/ {pageCount}</span></span>
 ...
 {/* Page Count */}
 <div className="space-y-3 pt-4 border-t border-slate-50 dark:border-slate-700">
 <span className="text-[11px] font-medium text-slate-400 uppercase tracking-widest">Number of Pages</span>
 <div className="flex items-center justify-between bg-slate-50 dark:bg-slate-900 rounded-xl p-2 border border-slate-100 dark:border-slate-700">
 ...
 <span className="font-medium text-slate-900 dark:text-white text-xs uppercase tracking-tight">{blankCount} {blankCount === 1 ? 'Page' : 'Pages'}</span>
 ...
 {/* Page Size */}
 <div className="space-y-3 pt-4 border-t border-slate-50 dark:border-slate-700">
 <span className="text-[11px] font-medium text-slate-400 uppercase tracking-widest">Dimensions</span>
 ...
 <h2 className="text-2xl sm:text-4xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">Add Blank Pages</h2>
 ...
 <h3 className="text-4xl font-bold text-slate-900 dark:text-white uppercase tracking-widest">Document Updated!</h3>
