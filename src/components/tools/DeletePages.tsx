...
export default function DeletePages({ id: _id }: { id: string }) {
 ...
 <h3 className="hidden lg:block text-xl font-bold text-slate-900 dark:text-white mb-6 uppercase tracking-tighter text-left">Removal Settings</h3>
 
 <div className="space-y-6 text-left">
 {/* Quick Selection */}
 <div className="space-y-3">
 <span className="text-[11px] font-medium text-slate-400 uppercase tracking-widest">Selection Controls</span>
 <div className="flex flex-col gap-2">
 <button onClick={selectAll} disabled={!file} className="w-full flex items-center justify-center gap-2 py-3 rounded-xl text-xs font-medium uppercase tracking-widest text-slate-600 dark:text-slate-300 bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 hover:bg-slate-100 transition-colors">
 <Eye size={14} /> Select All
 </button>
 <button onClick={clearAll} disabled={!file} className="w-full flex items-center justify-center gap-2 py-3 rounded-xl text-[11px] font-medium uppercase tracking-widest text-slate-600 dark:text-slate-300 bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 hover:bg-slate-100 transition-colors">
 ...
 <p className="text-xs font-medium text-red-500 uppercase tracking-tight leading-tight">
 ...
 <p className="text-[11px] font-medium text-slate-400 uppercase tracking-widest mb-1">Technical Info</p>
 <p className="text-xs font-medium text-slate-500 leading-tight uppercase tracking-tight">100% Client-side reconstruction</p>
 </div>
 </div>
 </div>
 </div>
 ...
 {/* Main Content Area */}
 <div className="flex-1 bg-white dark:bg-slate-800 rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-12 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-2xl transition-shadow duration-300 min-h-[500px] flex flex-col w-full relative overflow-hidden">
 ...
 <div className="p-6 bg-white dark:bg-slate-800 rounded-3xl shadow-sm hover:shadow-xl transition-shadow duration-300 text-red-500 mb-6 group-hover:scale-110 transition-transform">
 <Upload size={32} />
 </div>
 <div className="text-lg sm:text-lg sm:text-xl font-medium text-slate-800 dark:text-white mb-1">Select PDF to clean</div>
 ...
 <p className="text-lg font-medium text-slate-400 uppercase tracking-widest animate-pulse">Scanning Pages...</p>
 </div>
 )}
 ...
 <p className="text-[10px] font-medium text-slate-400 uppercase tracking-widest">{thumbs.length} Pages Loaded</p>
 </div>
 </div>
 ...
 {/* Page Number Label */}
 <div className={`absolute bottom-3 left-3 px-3 py-1 backdrop-blur-md text-white text-[10px] font-medium rounded-full border border-white/20 tracking-widest ${selected.has(i) ? 'bg-red-600' : 'bg-black/60'}`}>
 PAGE {i + 1}
 </div>
 </button>
 ))}
 ...
 className="w-full py-5 text-white rounded-[1.5rem] text-lg sm:text-xl font-medium shadow-xl hover:scale-[1.01] active:scale-[0.99] transition-all disabled:opacity-50 disabled:grayscale uppercase tracking-widest shadow-red-500/20"
 ...
 <h3 className="text-4xl font-bold text-slate-900 dark:text-white uppercase tracking-widest">Cleanup Complete</h3>
 ...
 className="flex-1 py-5 text-white rounded-2xl text-lg sm:text-xl font-medium shadow-xl hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-3 uppercase tracking-widest shadow-red-500/20"
 style={{ background: ACCENT_GRADIENT }}
 >
