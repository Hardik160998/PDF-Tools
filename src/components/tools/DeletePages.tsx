      ...
      <div className="flex flex-col lg:flex-row-reverse gap-6 items-start">
        ...
        <div className="flex-1 bg-white dark:bg-slate-800 rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-12 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-2xl transition-shadow duration-300 min-h-[500px] flex flex-col w-full relative overflow-hidden">
          ...
          <div className="relative text-center space-y-4 mb-10">
            ...
            {!file && <p className="text-sm sm:text-base text-slate-500 dark:text-slate-400 font-medium max-w-md mx-auto leading-relaxed">Pick pages to discard and download the trimmed document instantly.</p>}
          </div>
