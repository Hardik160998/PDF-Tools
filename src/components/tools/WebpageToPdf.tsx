...
export default function WebpageToPdf({ id: _id }: { id: string }) {
 ...
 <div className="bg-white dark:bg-slate-800 rounded-[1.2rem] sm:rounded-[2.5rem] p-4 sm:p-12 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-2xl transition-shadow duration-300 space-y-6 sm:space-y-10">
 ...
 <h2 className="text-2xl sm:text-4xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">Webpage to PDF</h2>
 ...
 <label className="text-[11px] font-medium uppercase tracking-widest text-slate-400">Website URL</label>
 ...
 <h3 className="text-xl sm:text-3xl font-bold text-slate-900 dark:text-white">Conversion Complete!</h3>
