            ...
            {!done ? (
                <div className="space-y-6">
                    ...
                    >
                        ...
                        <div className="space-y-4 pointer-events-none">
                            ...
                            <h3 className="text-2xl sm:text-3xl font-black text-slate-800 dark:text-white mb-2 tracking-tight text-center">Drop Meesho Label PDFs here</h3>
                ...
                (pdfUrl || pdfUrls.length > 0) && (
                    <div className="space-y-8 sm:space-y-12 animate-in zoom-in duration-700">
                        ...
                        <div className="space-y-4">
                            {pdfUrl && <button onClick={() => handleDownloadClick(pdfUrl, "meesho_labels.pdf")} className="w-full block py-4 sm:py-5 bg-[#f26522] hover:bg-[#d4541a] text-white rounded-2xl text-xl sm:text-2xl font-medium shadow-xl flex items-center justify-center gap-3"><Download size={24} /> Download PDF</button>}
                            {pdfUrls.length > 0 && (
                ...
                <div className="flex flex-col-reverse lg:flex-row-reverse gap-4 sm:gap-8 items-start">
                    <div className="w-full lg:w-[300px] bg-white dark:bg-slate-800 rounded-3xl border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-xl transition-shadow duration-300 h-fit lg:sticky lg:top-4 overflow-hidden flex-shrink-0">
                        ...
                        <div className={`${showSettings ? 'block' : 'hidden'} lg:block p-6`}>
                            <h3 className="hidden lg:block text-xl font-bold text-slate-900 dark:text-white mb-6 uppercase tracking-tighter">Settings</h3>
                            <div className="space-y-5">
                                <label className="flex items-start gap-3 cursor-pointer group">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-sm font-medium text-slate-700 dark:text-slate-300 group-hover:text-slate-900 dark:group-hover:text-white leading-tight">Sort by Quantity</span>
                                        <span className="text-[11px] text-slate-400 font-medium uppercase tracking-widest leading-none">Sort by Qty</span>
                                    </div>
                                </label>
                                <label className="flex items-start gap-3 cursor-pointer group">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-sm font-medium text-slate-700 dark:text-slate-300 group-hover:text-slate-900 dark:group-hover:text-white leading-tight">Sort by SKU ID</span>
                                        <span className="text-[11px] text-slate-400 font-medium uppercase tracking-widest leading-none">Group identical items</span>
                                    </div>
                                </label>
                                <label className="flex items-start gap-3 cursor-pointer group">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-sm font-medium text-slate-700 dark:text-slate-300 group-hover:text-slate-900 dark:group-hover:text-white leading-tight">Highlight SKU ID</span>
                                        <span className="text-[11px] text-slate-400 font-medium uppercase tracking-widest leading-none">Visible blue boxes</span>
                                    </div>
                                </label>
                                <label className="flex items-start gap-3 cursor-pointer group">
