...
export default function HeaderActions() {
 ...
 {/* Active Plan Badge */}
 <span className={`text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-full border shrink-0 ${
 ...
 <Link
 href="/premium-plans"
 className="hidden sm:inline-flex items-center gap-1 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white text-[10px] font-bold uppercase tracking-wider px-3.5 py-1.5 rounded-full shadow-md shadow-orange-500/25 transition-all hover:scale-[1.03]"
 >
 ...
 <div className="w-full h-full rounded-full bg-white dark:bg-slate-900 flex items-center justify-center text-[11px] font-bold text-slate-800 dark:text-slate-100">
 {getAvatarInitials()}
 </div>
 </div>
 ...
 <Link
 href="/login"
 className="text-[13px] font-bold text-slate-700 dark:text-slate-300 hover:text-red-500 px-1 py-2 transition-all"
 >
 Login
 </Link>
 <Link
 href="/signup"
 className="inline-flex items-center justify-center bg-[#ef4444] hover:bg-[#dc2626] text-white text-[11px] font-bold uppercase tracking-wider px-5 py-2.5 rounded-full shadow-lg shadow-red-500/25 transition-all duration-200 hover:scale-[1.03]"
 >
 SIGN UP
 </Link>
 </div>
