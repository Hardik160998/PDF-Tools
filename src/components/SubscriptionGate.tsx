            ...
            {!user ? (
              <>
                <Link
                  ...
                  className="w-full sm:w-auto inline-flex items-center justify-center bg-slate-900 hover:bg-slate-800 dark:bg-white dark:hover:bg-slate-100 text-white dark:text-slate-900 text-xs font-black uppercase tracking-wider px-8 py-4 rounded-2xl shadow-lg transition-all"
                >
                  LOG IN TO UNLOCK
                </Link>
                <Link
                  href="/premium-plans"
                  className="w-full sm:w-auto inline-flex items-center justify-center bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white text-xs font-black uppercase tracking-wider px-8 py-4 rounded-2xl shadow-lg shadow-orange-500/20 transition-all hover:scale-[1.02]"
                >
