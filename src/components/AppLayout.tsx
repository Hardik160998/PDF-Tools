...
export default function AppLayout({
 ...
 {/* Left — Logo */}
 <Link href="/" className={`${latoClass} flex items-center gap-1.5 font-bold text-2xl tracking-tighter hover:opacity-80 transition-opacity justify-self-start`}>
 ...
 <Link key={label} href={href} className={`${latoClass} text-[14px] font-medium text-slate-500 dark:text-slate-400 hover:text-red-500 transition-colors uppercase tracking-wider whitespace-nowrap`}>
 {label}
 </Link>
 ))}
 <ConvertDropdown />
 ...
 <Link href="/" className={`${latoClass} flex items-center gap-1.5 font-bold text-xl tracking-tighter`}>
 <span className="text-slate-900 dark:text-white uppercase">Smart</span>
 ...
 {/* Col 2 — Quick Links */}
 <div className="space-y-4">
 <h4 className="text-xs font-bold uppercase tracking-widest text-slate-900 dark:text-white">Quick Links</h4>
 ...
 <div className="space-y-4">
 <h4 className="text-xs font-bold uppercase tracking-widest text-slate-900 dark:text-white">Get In Touch</h4>
