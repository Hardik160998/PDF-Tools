  ...
  return (
    <div className="w-full max-w-md bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 sm:p-12 shadow-2xl relative z-10 auth-card">
      ...
      <div className="text-center space-y-2 mb-8">
        <h3 className="font-outfit text-2xl font-[900] tracking-tight text-slate-900 dark:text-white flex items-center justify-center gap-2">
...
export default function ResetPasswordPage() {
  return (
    <div id="auth-page-container" className="min-h-screen w-full bg-slate-950 flex items-center justify-center font-sans p-4 relative overflow-hidden">
