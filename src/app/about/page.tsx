...
export default function AboutPage() {
 ...
 <a href="/" className="inline-flex items-center gap-2 px-6 py-3 bg-red-500 hover:bg-red-600 text-white rounded-xl font-bold text-sm transition-all shadow-lg shadow-red-500/20">
 ...
 <div>
 <p className="font-bold text-slate-900 text-sm group-hover:text-red-500 transition-colors">{label}</p>
 ...
 <a href="/" className="inline-flex items-center gap-2 px-5 py-2.5 bg-slate-900 hover:bg-slate-700 text-white rounded-xl font-bold text-sm transition-all">
 ...
 <div className={`w-10 h-10 rounded-full flex items-center justify-center text-xs font-bold text-white shrink-0 ${i === TIMELINE.length - 1 ? 'bg-red-500' : 'bg-slate-300'}`}>
 ...
 <span className="text-xs font-bold text-red-500 uppercase tracking-widest">{year}</span>
 </div>
 ...
 <a href="/" className="px-6 py-3 bg-white text-red-600 rounded-xl font-bold text-sm hover:bg-red-50 transition-all shadow-lg">
 Start Using Free Tools
 </a>
 <a href="/contact" className="px-6 py-3 bg-white/20 text-white rounded-xl font-bold text-sm hover:bg-white/30 transition-all border border-white/30">
 Contact Us
 </a>
 </div>
 </div>
