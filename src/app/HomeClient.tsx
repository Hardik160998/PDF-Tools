        ...
        <div className="min-h-screen relative overflow-hidden">
            ...
            <section className="container mx-auto px-4 pt-24 pb-8 text-center relative z-10">
                <div className="max-w-6xl mx-auto space-y-8">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-outfit font-black leading-[1.1] tracking-tighter fade-in-up stagger-1 lg:whitespace-nowrap">
