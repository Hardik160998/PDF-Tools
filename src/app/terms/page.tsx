...
export default function TermsPage() {
 ...
 <a href="/contact" className="inline-flex items-center gap-2 px-5 py-2.5 bg-purple-500 hover:bg-purple-600 text-white rounded-xl font-bold text-sm transition-all">
 Contact Us <ArrowRight size={14} />
 </a>
 <a href="/privacy" className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/10 hover:bg-white/20 text-white rounded-xl font-bold text-sm transition-all border border-white/20">
 View Privacy Policy
 </a>
 </div>
 </div>
