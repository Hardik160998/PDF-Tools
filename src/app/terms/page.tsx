...
const ALLOWED = [
  ...
  "Use SmartPDFs Pro tools for client work and business purposes",
  "Share the SmartPDFs Pro website link with others",
];
...
const NOT_ALLOWED = [
  ...
  "Resell or redistribute SmartPDFs Pro as your own product",
    ...
    content: [
      {
        ...
        text: 'By accessing or using SmartPDFs Pro ("the Service"), you agree to be bound by these Terms and Conditions ("Terms"). If you do not agree to these Terms, please do not use our service.',
      },
      {
        subtitle: "Updates to Terms",
        text: "We reserve the right to update these Terms at any time. We will notify users of significant changes by posting a notice on our website at least 14 days before changes take effect. Continued use of SmartPDFs Pro after changes constitutes acceptance of the updated Terms.",
      },
      {
        subtitle: "Age Requirement",
        text: "You must be at least 13 years old to use SmartPDFs Pro. By using our service, you confirm that you meet this age requirement. Users under 18 should have parental consent.",
      },
    ],
  },
  {
    ...
    content: [
      {
        ...
        text: "SmartPDFs Pro is provided for lawful personal and commercial use. You may use our tools to process your own documents or documents you have legal permission to modify.",
      },
      {
        subtitle: "Prohibited Activities",
        text: "You agree not to use SmartPDFs Pro to process illegal content, upload malware, attempt to exploit our systems, use automated abuse tools, or infringe on intellectual property rights. Violations may result in immediate termination of access.",
      },
      {
        subtitle: "Commercial Use",
        text: "Commercial use of SmartPDFs Pro is permitted. You may use our tools for client work, business document processing, and commercial projects at no charge. You may not resell or white-label our service without written permission.",
      },
    ],
  },
  {
    ...
    content: [
      {
        ...
        text: "Most SmartPDFs Pro tools (Merge, Split, Compress, Organize, Watermark, Page Numbers, Edit Metadata, PDF to JPG, JPG to PDF, PDF to Text, PDF to XML, Unlock, Protect, Aadhar Cropper) process files entirely in your browser. Your files never leave your device.",
      },
      {
      ...
      },
      {
        ...
        text: "You are solely responsible for the files you upload and process. You warrant that you have the legal right to process any files submitted to SmartPDFs Pro. We are not responsible for the content of files processed through our service.",
      },
      {
        subtitle: "No Backup Guarantee",
        text: "SmartPDFs Pro does not store your files. We strongly recommend keeping backups of your original documents before processing. We are not liable for any data loss resulting from use of our tools.",
      },
    ],
  },
  {
    ...
    content: [
      {
        ...
        text: "All content, design, code, branding, logos, and user interface elements of SmartPDFs Pro are the intellectual property of SmartPDFs Pro and its licensors, protected by copyright and trademark laws.",
      },
      {
        subtitle: "Your Files",
        text: "Your uploaded files remain entirely your property. SmartPDFs Pro claims no ownership, license, or rights over any documents you process through our service. We do not use your file content for any purpose other than performing the requested operation.",
      },
      {
        subtitle: "Open Source Components",
        text: "SmartPDFs Pro uses open-source libraries including pdf-lib (MIT License) and PDF.js (Apache 2.0 License). These components are used in accordance with their respective licenses.",
      },
    ],
  },
  {
    ...
    content: [
      {
        ...
        text: 'SmartPDFs Pro is provided "as is" and "as available" without warranties of any kind, either express or implied. We do not warrant that the service will be uninterrupted, error-free, or completely secure.',
      },
      {
    ...
    content: [
      {
        ...
        text: "To the maximum extent permitted by applicable law, SmartPDFs Pro shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of data, loss of profits, loss of business, or business interruption.",
      },
      {
    ...
    content: [
      {
        ...
        text: "We reserve the right to modify, suspend, or discontinue any part of SmartPDFs Pro at any time, with or without notice. We may add, remove, or change tools and features as we see fit.",
      },
      {
        subtitle: "Termination of Access",
        text: "We reserve the right to terminate or restrict your access to SmartPDFs Pro if you violate these Terms, abuse our service, or engage in any activity that harms other users or our infrastructure.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        text: "Any disputes arising from these Terms or use of SmartPDFs Pro shall first be attempted to be resolved through good-faith negotiation. If unresolved, disputes shall be subject to the exclusive jurisdiction of the courts of Gujarat, India.",
      },
      {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="container mx-auto px-4 pt-16 pb-10 text-center max-w-3xl">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-50 text-purple-600 border border-purple-100 text-xs font-bold uppercase tracking-widest mb-6">
        ...
        <p className="text-slate-500 leading-relaxed max-w-xl mx-auto mb-3">
          Please read these terms carefully before using SmartPDFs Pro. By using
          our service, you agree to these terms.
        </p>
        <p className="text-xs text-slate-400 font-medium">
          Last updated: April 27, 2026 · Effective immediately · Governed by
          Indian Law
        </p>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="bg-green-50 rounded-2xl p-6 border border-green-100">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-black text-green-800 text-sm uppercase tracking-widest">
                You Can
              </h2>
            </div>
          ...
          <div className="bg-red-50 rounded-2xl p-6 border border-red-100">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-black text-red-800 text-sm uppercase tracking-widest">
                You Cannot
              </h2>
            </div>
            <ul className="space-y-2">
      ...
      <section className="container mx-auto px-4 pb-16 max-w-4xl">
        ...
        <div className="mt-10 bg-slate-900 rounded-2xl p-8 text-center text-white space-y-4">
          ...
          <p className="text-slate-400 text-sm max-w-md mx-auto">
            ...
            contact us. We're happy to clarify anything.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              href="/contact"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-purple-500 hover:bg-purple-600 text-white rounded-xl font-bold text-sm transition-all"
            >
