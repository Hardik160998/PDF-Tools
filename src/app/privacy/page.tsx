...
export default function PrivacyPage() {
 ...
 <span className="font-bold text-green-700 text-sm">100% Browser-Based (No Upload)</span>
 </div>
 ...
 <span className="font-bold text-blue-700 text-sm">Server-Side (File Deleted in 1hr)</span>
 </div>
 <div className="flex flex-wrap gap-1.5">
 ...
 <h3 className="font-bold text-slate-700 text-sm mb-1.5">{item.subtitle}</h3>
 ...
 <a href="/contact" className="inline-flex items-center gap-2 px-5 py-2.5 bg-green-500 hover:bg-green-600 text-white rounded-xl font-bold text-sm transition-all">
 Contact Privacy Team <ArrowRight size={14} />
 </a>
 <a href="/terms" className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/10 hover:bg-white/20 text-white rounded-xl font-bold text-sm transition-all border border-white/20">
