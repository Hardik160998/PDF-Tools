...
const HIGHLIGHTS = [
  {
    ...
    desc: "We never read or analyze your PDF content",
    color: "bg-green-500",
  },
  {
    icon: Trash2,
    title: "Auto-Deleted",
    desc: "Server files deleted within 1 hour",
    color: "bg-orange-500",
  },
  {
    icon: Lock,
    title: "HTTPS Encrypted",
    desc: "All transfers use TLS encryption",
    color: "bg-blue-500",
  },
  {
    icon: Users,
...
const SECTIONS = [
  {
    ...
    content: [
      ...
      },
      {
        ...
        text: "We may collect anonymous, aggregated usage data such as page views and tool usage counts to understand how SmartPDFs Pro is used and improve our services. This data contains no personally identifiable information.",
      },
    ],
  },
  {
    ...
    content: [
      {
        ...
        text: "SmartPDFs Pro uses only essential cookies required for basic site functionality (such as remembering your theme preference). We do not use advertising cookies, tracking pixels, or third-party marketing cookies.",
      },
      {
    ...
    content: [
      {
        ...
        text: "The majority of SmartPDFs Pro tools process files entirely in your browser. Your PDF never leaves your device. This is the most secure approach possible — there is no server involved, no network transfer, and no risk of interception.",
      },
      {
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        text: "Continued use of SmartPDFs Pro after policy changes constitutes acceptance of the updated policy. If you do not agree with changes, please discontinue use and contact us to request data deletion.",
      },
    ],
  },
];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="container mx-auto px-4 pt-16 pb-10 text-center max-w-3xl">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-50 text-green-600 border border-green-100 text-xs font-bold uppercase tracking-widest mb-6">
        ...
        <p className="text-slate-500 leading-relaxed max-w-xl mx-auto mb-3">
          SmartPDFs Pro is built with a privacy-first approach. Most tools
          process files entirely in your browser — your documents never leave
          your device.
        </p>
            ...
            <div className="bg-white rounded-xl p-4 border border-green-100">
              ...
              <div className="flex flex-wrap gap-1.5">
                {[
                  ...
                  <span
                    key={t}
                    className="text-[10px] font-bold bg-green-50 text-green-700 px-2 py-0.5 rounded-full border border-green-100"
                  >
                    {t}
                  </span>
                ))}
            ...
            <div className="bg-white rounded-xl p-4 border border-blue-100">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-bold text-blue-700 text-sm">
                  Server-Side (File Deleted in 1hr)
                </span>
              </div>
              <div className="flex flex-wrap gap-1.5">
                {[
                  ...
                  <span
                    key={t}
                    className="text-[10px] font-bold bg-blue-50 text-blue-700 px-2 py-0.5 rounded-full border border-blue-100"
                  >
                    {t}
                  </span>
                ))}
      ...
      <section className="container mx-auto px-4 pb-16 max-w-4xl">
        ...
        <div className="mt-10 bg-slate-900 rounded-2xl p-8 text-center text-white space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              href="/contact"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-green-500 hover:bg-green-600 text-white rounded-xl font-bold text-sm transition-all"
            >
