...
export async function POST(request: Request) {
 ...
 <p style="color: rgba(255,255,255,0.8); margin: 4px 0 0; font-size: 13px;">SmartPDFs Pro — Contact Form</p>
 </div>
 ...
 <p style="text-align: center; color: #94a3b8; font-size: 11px; margin-top: 20px;">Sent from SmartPDFs Pro contact form</p>
 </div>
 `,
    });
