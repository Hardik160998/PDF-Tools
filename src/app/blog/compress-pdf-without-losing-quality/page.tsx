...
export const metadata: Metadata = {
  title:
    "How to Compress a PDF Without Losing Quality (Free Guide) | SmartPDFs Plus",
  description:
    ...
    <main className="min-h-screen">
      ...
      <article className="container mx-auto px-4 pt-10 pb-20 max-w-3xl">
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-slate-600">
          ...
          >
            <p className="font-black text-green-800 text-sm mb-3 uppercase tracking-wider">
              Key Takeaways
            </p>
          ...
          <section aria-labelledby="how-to-compress">
            ...
            <p className="leading-relaxed mb-6">
              ...
              your files. SmartPDFs Plus offers a completely free, browser-based
            ...
            <div className="space-y-4">
              <div className="flex gap-5 p-5 bg-white rounded-2xl border border-slate-200 shadow-sm">
                <div
                  className="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center text-white font-black text-lg shrink-0 shadow-md"
                  aria-hidden="true"
                >
                  1
                </div>
