...
export default function BlogPage() {
 ...
 <h3 className="text-xl font-bold text-slate-900">Want More PDF Tips?</h3>
 <p className="text-slate-500 text-sm max-w-md mx-auto">
 Explore all our free PDF tools and start working smarter with your documents today.
 </p>
 <div className="flex justify-center">
 <a href="/" className="inline-flex items-center gap-2 px-6 py-3 bg-red-500 hover:bg-red-600 text-white rounded-xl font-bold text-sm transition-all shadow-lg hover:shadow-red-500/20">
