...
export const metadata: Metadata = {
  title:
    "How to Rearrange, Rotate & Delete PDF Pages Online (Free Guide) | SmartPDFs Plus",
  description:
    ...
    <main className="min-h-screen">
      ...
      <article className="container mx-auto px-4 pt-10 pb-20 max-w-3xl">
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-slate-600">
          ...
          >
            <p className="font-black text-purple-800 text-sm mb-3 uppercase tracking-wider">
              Key Takeaways
            </p>
          ...
          <section aria-labelledby="how-to-organize-online">
            ...
            <div className="space-y-4">
              <div className="flex gap-5 p-5 bg-white rounded-2xl border border-slate-200 shadow-sm">
                <div
                  className="w-10 h-10 bg-purple-500 rounded-full flex items-center justify-center text-white font-black text-lg shrink-0 shadow-md"
                  aria-hidden="true"
                >
                  1
                </div>
          ...
          <section aria-labelledby="keyboard-shortcuts">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-6">
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 flex justify-between items-center shadow-sm">
                ...
                <kbd className="px-3 py-1.5 bg-white border border-slate-300 rounded-lg text-xs font-black shadow-sm">
                  Shift + Click
                </kbd>
              </div>
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 flex justify-between items-center shadow-sm">
