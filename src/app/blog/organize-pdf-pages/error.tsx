...
export default function Error({
 ...
 <button onClick={() => reset()} className="px-6 py-2.5 bg-purple-500 hover:bg-purple-600 text-white rounded-xl font-bold transition-colors">
 Try again
 </button>
 <Link href="/blog" className="px-6 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl font-bold transition-colors">
 Back to Blog
 </Link>
 </div>
 </div>
