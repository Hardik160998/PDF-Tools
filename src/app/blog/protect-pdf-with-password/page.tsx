...
export const metadata: Metadata = {
  title:
    "How to Password Protect a PDF: AES-256 Encryption Guide | SmartPDFs Plus",
  description:
  ...
  return (
    <main className="min-h-screen">
      ...
      <WebAppSchema
        ...
        url="https://smartpdfpro.com/tool/protect"
      />
            ...
            <div className="bg-red-50 border-l-4 border-red-500 p-5 rounded-r-xl my-6 flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-red-800 leading-relaxed m-0">
                  SmartPDFs Plus utilizes a Zero-Knowledge architecture. We do
