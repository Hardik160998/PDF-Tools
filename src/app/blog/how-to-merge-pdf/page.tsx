    ...
    <main className="min-h-screen">
      ...
      <article className="container mx-auto px-4 pt-10 pb-20 max-w-3xl">
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-slate-600">
          ...
          >
            <p className="font-black text-orange-800 text-sm mb-3 uppercase tracking-wider">
              What you&apos;ll learn
            </p>
          ...
          <section aria-labelledby="how-to-merge-online">
            <h2
              ...
              className="text-2xl font-black text-slate-900 mt-10 mb-6"
            >
            ...
            <div className="space-y-4">
              <div className="flex gap-5 p-5 bg-white rounded-2xl border border-slate-200 shadow-sm">
                <div
                  className="w-10 h-10 bg-orange-500 rounded-full flex items-center justify-center text-white font-black text-lg shrink-0 shadow-md"
                  aria-hidden="true"
                >
                  1
                </div>
