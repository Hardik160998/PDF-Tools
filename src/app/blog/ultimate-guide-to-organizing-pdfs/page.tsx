...
export const metadata: Metadata = {
  title:
    "The Ultimate Guide to Organizing PDFs — Merge, Split & Rearrange | SmartPDFs Pro",
  description:
...
export default function UltimateGuidePdfsPost() {
  ...
  return (
    <main className="min-h-screen">
      <ArticleSchema
        title="The Ultimate Guide to Organizing PDFs — Merge, Split & Rearrange | SmartPDFs Pro"
      ...
      <article className="container mx-auto px-4 pt-10 pb-20 max-w-3xl">
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-slate-600">
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-white dark:from-slate-900 dark:to-slate-800 border-2 border-indigo-500 rounded-3xl p-8 text-center text-slate-900 space-y-4 shadow-lg hover:shadow-xl transition-all duration-300 mt-12 mb-8">
            <div>
