...
export default function CropSnapdealLabelPost() {
 ...
 {/* Call to Action */}
 <section className="bg-gradient-to-br from-white to-red-50/30 dark:from-slate-900 dark:to-slate-800 border-2 border-red-600 rounded-2xl p-8 text-center shadow-lg hover:shadow-xl transition-shadow mt-10">
