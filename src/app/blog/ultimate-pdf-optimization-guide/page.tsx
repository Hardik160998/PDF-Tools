    ...
    <main className="min-h-screen">
      ...
      <article className="container mx-auto px-4 pt-10 pb-20 max-w-3xl">
        ...
        >
          ...
          {/* Call to Action */}
          <section className="bg-gradient-to-br from-white to-amber-50/30 dark:from-slate-900 dark:to-slate-800 border-2 border-amber-500 rounded-2xl p-8 text-center shadow-lg hover:shadow-xl transition-shadow mt-10">
