...
export const metadata: Metadata = {
  ...
  keywords:
    "amazon label crop, crop amazon label with invoice, amazon thermal print, print amazon label 4x6, amazon seller tools, amazon easy ship, amazon fba",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  return (
    <main className="min-h-screen">
      ...
      <WebAppSchema
        ...
        description="Perfectly crop and format Amazon shipping labels and tax invoices for 4x6 thermal printers. Free online tool for Amazon FBA and Easy Ship sellers."
        url="https://smartpdfpro.com/tool/amazon-cropper"
      />
      ...
      <article className="container mx-auto px-4 pt-10 pb-20 max-w-3xl">
        ...
        <header className="mb-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 text-xs text-slate-400 font-medium flex-wrap">
                <span className="text-[10px] font-bold uppercase tracking-widest bg-white text-yellow-600 border-2 border-yellow-500 px-2 py-0.5 rounded-full shadow-sm">
                  Ecommerce
                </span>
          ...
          <figure className="relative rounded-2xl overflow-hidden shadow-2xl mb-8 border border-slate-100 bg-slate-50">
            ...
            <figcaption className="sr-only">
              Comprehensive guide to extracting and formatting Amazon shipping
              documents.
            </figcaption>
          </figure>
        </header>
        ...
        >
          <p className="text-lg text-slate-600 leading-relaxed font-medium">
            Processing orders on Amazon Seller Central is the heartbeat of
            millions of businesses worldwide. However, Amazon's default PDF
            generation for shipping labels is heavily optimized for traditional
            A4 laser printers, not the modern 4x6 inch thermal printers that
            professional warehouses rely on.
          </p>
          <p className="text-lg text-slate-600 leading-relaxed font-medium">
            Whether you are utilizing Amazon Easy Ship, FBA (Fulfillment by
            Amazon), or Seller Flex, manually cutting and taping A4 sheets slows
            down your dispatch metrics. In this comprehensive guide, we will
            analyze the precise layout of Amazon's ATS (Amazon Transportation
            Services) labels, explain why DPI preservation is critical for
            scanning, and show you how to automate your cropping workflow.
          </p>
          ...
          >
            <h2
              id="toc-heading"
              className="font-bold text-yellow-900 text-lg mb-4 mt-0"
            >
              What You Will Learn
            </h2>
            <ul className="space-y-3 m-0 list-none p-0">
              {[
                ...
                <li
                  key={i}
                  className="flex items-start gap-3 text-sm text-yellow-800 leading-relaxed"
                >
                  <CheckCircle2
                    size={16}
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              When you bulk-download orders from Amazon Seller Central, the
              system generates a standard A4 PDF (210mm x 297mm). The top half
              contains the ATS routing code, barcode, and customer shipping
              address. The bottom half contains the GST tax invoice and itemized
              product list.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
              <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-sm text-slate-600 leading-relaxed m-0">
                  If you send the A4 file straight to a thermal printer (like a
                  TSC TE244), it shrinks the entire page to fit a 4-inch width.
                  This causes the intricate lines of the barcode to blur
                  together.
                </p>
              </div>
              ...
              <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center gap-2 mb-2 text-slate-900">
                  <Truck
                    ...
                    aria-hidden="true"
                  />
                  <h3 className="font-bold text-sm m-0">The ATS Requirement</h3>
                </div>
                <p className="text-sm text-slate-600 leading-relaxed m-0">
                  Amazon Transportation Services (ATS) uses automated laser
                  scanners in their hubs. If the barcode is rasterized or
                  shrunk, the scanner fails, leading to delayed fulfillment
                  metrics.
                </p>
              </div>
            </div>
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              ...
              mark. Page 1 becomes the top half (the shipping label) perfectly
              formatted to a 4x6 (100x150mm) aspect ratio. Page 2 becomes the
              bottom half (the invoice). You can then print this multi-page
              document sequentially directly onto your thermal roll.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-slate-600 leading-relaxed">
              As a seller, you are legally responsible for the PII (Personally
              Identifiable Information) of your customers, including their full
              names, physical addresses, and contact numbers.
            </p>
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-500 p-5 rounded-r-xl my-6 flex gap-4">
              ...
              />
              <div>
                <h3 className="font-bold text-yellow-900 text-base mt-0 mb-1">
          ...
          <section>
            ...
            <ol className="space-y-4 my-6 list-none p-0">
              {[
                ...
                >
                  <div className="w-8 h-8 bg-yellow-500 rounded-full flex items-center justify-center text-white font-bold text-sm shrink-0">
                    {i + 1}
                  </div>
                  <div>
          ...
          <section>
            ...
            >
              {[
                ...
                <div
                  key={i}
                  className="bg-slate-50 rounded-xl p-5 border border-slate-100 hover:border-yellow-200 transition-colors"
                  itemScope
                  itemProp="mainEntity"
          ...
          {/* Call to Action */}
          <section className="bg-gradient-to-br from-white to-yellow-50/30 dark:from-slate-900 dark:to-slate-800 border-2 border-yellow-500 rounded-2xl p-8 text-center shadow-lg hover:shadow-xl transition-shadow mt-10">
            <h2 className="font-black text-2xl text-slate-900 mt-0 mb-3">
              Upgrade Your Amazon Fulfillment
            </h2>
            <p className="text-slate-600 mb-6 text-sm">
              Stop folding A4 paper. Automate your Amazon label cropping and
