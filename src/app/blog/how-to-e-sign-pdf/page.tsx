...
export default function ESignPDFGuidePost() {
 ...
 <span className="text-[10px] font-bold uppercase tracking-widest bg-white text-emerald-700 border-2 border-emerald-600 px-2 py-0.5 rounded-full shadow-sm">
 Security
 </span>
 ...
 aria-hidden="true"
 />
 <h3 className="font-bold text-sm m-0">Digital Signature</h3>
 </div>
 <p className="text-sm text-slate-600 leading-relaxed m-0">
 ...
 >
 <div className="w-8 h-8 bg-emerald-600 rounded-full flex items-center justify-center text-white font-bold text-sm shrink-0">
 {i + 1}
 </div>
 <div>
 ...
 {/* Call to Action */}
 <section className="bg-gradient-to-br from-white to-emerald-50/30 dark:from-slate-900 dark:to-slate-800 border-2 border-emerald-600 rounded-2xl p-8 text-center shadow-lg hover:shadow-xl transition-shadow mt-10">
