...
export default function SkeletonPreviewPage() {
 ...
 <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Skeleton Preview</span>
 </div>
 ...
 <span className="text-xs font-bold uppercase tracking-widest text-slate-500">Variant {v}</span>
 </div>
 <button
 onClick={() => setRemoved(r => ({ ...r, [active]: v }))}
 className="px-3 py-1 rounded-lg text-[10px] font-bold uppercase tracking-wider bg-red-50 dark:bg-red-900/20 text-red-500 hover:bg-red-100 transition-all border border-red-200 dark:border-red-800"
 >
 Remove {v}
 </button>
 </div>
 ...
 className="px-3 py-1.5 rounded-lg text-[10px] font-bold uppercase bg-slate-100 dark:bg-slate-700 text-slate-500 hover:bg-slate-200 transition-all"
 >
 Reset
 </button>
 </div>
