...
export default function ProfilePage() {
  ...
  const handleDownloadReceipt = async () => {
    ...
    try {
      ...
      const priceINR =
        userPlan === "Yearly Pro" ? "INR 1,699.00" : "INR 399.00";
      ...
      page.drawText(`Invoice Number: ${invoiceNum}`, {
        x: 40,
        y: 695,
        size: 10,
        font: helvetica,
      ...
      page.drawText(`Name: ${fullName || "SmartPDFs Customer"}`, {
        x: 320,
        y: 695,
        size: 10,
        font: helvetica,
      ...
      // Table Row
      page.drawText(
        `SmartPDFs Pro - ${userPlan} Subscription (${cycle} Cycle)`,
        { x: 50, y: 555, size: 10, font: helvetica },
      );
      page.drawText("1", { x: 350, y: 555, size: 10, font: helvetica });
      page.drawText(`${priceINR} (${priceUSD} USD)`, {
        x: 480,
        y: 555,
        size: 10,
        font: helvetica,
      ...
      page.drawText(`${priceINR} (${priceUSD})`, {
        x: 470,
        y: 505,
        size: 10,
        font: helvetica,
              ...
              <div className="bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200/60 dark:border-slate-800/80 rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-100/50 dark:shadow-none space-y-6">
                ...
                <div className="space-y-4 pt-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="flex justify-between items-center py-3 border-b border-slate-100 dark:border-slate-800/60"
                    >
              ...
              <div className="bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200/60 dark:border-slate-800/80 rounded-3xl p-6 shadow-xl space-y-5">
                ...
                <div className="space-y-3 pt-2">
                  {[1, 2].map((i) => (
                    <div
                      key={i}
                      className="h-16 bg-slate-200 dark:bg-slate-800 rounded-2xl w-full"
                    />
                  ))}
                </div>
              </div>
      ...
      <div className="w-full max-w-7xl mx-auto space-y-8">
        ...
        <div className="relative overflow-hidden bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200/60 dark:border-slate-800/80 rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-100/50 dark:shadow-none flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8">
          ...
          <div className="relative w-24 h-24 rounded-3xl bg-gradient-to-tr from-amber-500 via-indigo-600 to-purple-600 p-[3px] shadow-lg flex-shrink-0">
            <div className="w-full h-full rounded-[21px] bg-white dark:bg-slate-950 flex items-center justify-center text-3xl font-bold text-slate-800 dark:text-slate-100">
              {getAvatarInitials()}
            </div>
            {/* VIP Golden Badge */}
          ...
          <div className="flex-1 text-center md:text-left space-y-3 relative z-10">
            <div className="space-y-1">
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-2">
                ...
                <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold tracking-wider uppercase bg-amber-500/10 text-amber-500 border border-amber-500/20">
                  <Crown size={10} className="fill-amber-500" />{" "}
                  {userPlan === "Basic Plan" ? "BASIC MEMBER" : "PRO VIP"}
                </span>
              </div>
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-2 text-xs font-semibold text-zinc-500 dark:text-zinc-400">
              <span className="flex items-center gap-1.5">
                <Mail size={14} className="text-zinc-400 dark:text-zinc-300" />{" "}
                {user.email}
              </span>
              <span className="flex items-center gap-1.5">
                <Calendar
          ...
          <div className="relative overflow-hidden bg-gradient-to-tr from-amber-500/10 via-purple-600/10 to-indigo-600/10 dark:from-amber-500/20 dark:via-purple-600/20 dark:to-indigo-600/20 border border-amber-500/20 dark:border-amber-400/30 rounded-2xl p-4 flex flex-col items-center justify-center text-center w-full md:w-44 flex-shrink-0">
            ...
            <span className="text-[10px] font-bold tracking-widest uppercase text-amber-600 dark:text-amber-400 flex items-center gap-1">
              <Award size={10} /> MEMBERSHIP
            </span>
            <span className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-purple-600 dark:from-amber-400 dark:to-purple-400 mt-1 uppercase">
              {userPlan}
            </span>
            <span className="text-[9px] font-bold text-zinc-500 dark:text-zinc-400 mt-0.5">
              {userPlan === "Basic Plan"
                ? "Upgrade for Pro Tools 🔓"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="relative group overflow-hidden bg-gradient-to-tr from-amber-500/10 via-purple-600/10 to-indigo-600/10 dark:from-purple-900/40 dark:via-indigo-950/60 dark:to-slate-950 dark:bg-slate-950 border border-amber-500/20 dark:border-purple-500/30 rounded-3xl p-6 sm:p-8 shadow-xl transition-all duration-300 hover:shadow-indigo-500/5 hover:border-amber-500/30">
              ...
              <div className="relative flex flex-col justify-between h-48">
                ...
                <div className="flex justify-between items-start">
                  <div className="space-y-1">
                    <span className="inline-flex items-center gap-1 bg-amber-500/10 dark:bg-amber-400/20 text-amber-600 dark:text-amber-400 text-[9px] font-bold uppercase tracking-widest px-2.5 py-0.5 rounded-full border border-amber-500/20 dark:border-amber-400/30">
                      SmartPDFs Pro Pass
                    </span>
                    <p className="text-[10px] text-zinc-500 dark:text-zinc-300 uppercase tracking-widest font-bold">
                      {userPlan === "Free Plan"
                        ? "STANDARD IDENTITY"
                        : `${userPlan.replace(" Plan", "").toUpperCase()} VIP IDENTITY`}
                    </p>
                  </div>
                  <Crown
                ...
                <div className="flex justify-between items-end border-t border-zinc-200/50 dark:border-zinc-800/80 pt-4">
                  <div className="min-w-0">
                    <p className="text-[9px] text-zinc-500 dark:text-zinc-400 uppercase tracking-wider font-bold">
                      PASS HOLDER
                    </p>
                    <p className="text-sm font-bold truncate max-w-[200px] text-zinc-800 dark:text-zinc-100">
                      {profile?.full_name || "SmartPDFs VIP Member"}
                    </p>
                  </div>
            ...
            <div className="bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200/60 dark:border-slate-800/80 rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-100/50 dark:shadow-none space-y-6">
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-black tracking-tight text-slate-800 dark:text-white flex items-center gap-2">
                  <Settings size={18} className="text-indigo-500" /> Account
                  Settings
                </h2>
              ...
              <form onSubmit={handleUpdateProfile} className="space-y-4">
                <div className="space-y-2">
                  <label className="text-[11px] font-bold text-zinc-500 dark:text-zinc-400 tracking-wider uppercase">
                    Full Name
                  </label>
                  <input
                    type="text"
              ...
              <div className="border-t border-slate-100 dark:border-slate-800/80 pt-6 mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3 p-4 bg-slate-50/50 dark:bg-slate-950/20 border border-slate-100 dark:border-slate-800/50 rounded-2xl">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] text-zinc-500 dark:text-zinc-300 leading-normal">
                      Your files and actions are logged using local sandboxing.
                ...
                <div className="flex items-start gap-3 p-4 bg-slate-50/50 dark:bg-slate-950/20 border border-slate-100 dark:border-slate-800/50 rounded-2xl">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] text-zinc-500 dark:text-zinc-300 leading-normal">
                      Secured via industry-standard Supabase identity
                      management. Your credentials are fully encrypted.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200/60 dark:border-slate-800/80 rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-100/50 dark:shadow-none space-y-6">
              <h2 className="text-xl font-black tracking-tight text-zinc-800 dark:text-white flex items-center gap-2">
                <CreditCard size={18} className="text-indigo-500" /> License
                &amp; Billing
              </h2>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-3 border-b border-slate-100 dark:border-slate-800/60">
                  ...
                  >
                    {userPlan !== "Basic Plan"
                      ? `${userPlan} (${profile?.subscription_status || "active"})`
                      : "Basic Plan"}
                  </span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-slate-100 dark:border-slate-800/60">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-b from-white/80 to-white/60 dark:from-slate-900/70 dark:to-slate-900/40 backdrop-blur-xl border border-slate-200/60 dark:border-slate-800/80 rounded-3xl p-6 shadow-xl shadow-slate-100/50 dark:shadow-none space-y-5">
              <h2 className="text-base font-black tracking-tight text-zinc-800 dark:text-white flex items-center gap-2">
                <Sparkles size={16} className="text-amber-500" /> Active Pro
                Privileges
              </h2>
                ...
                {[
                  {
                    ...
                    desc: "No hourly caps on batch conversions.",
                  },
                  {
                    title: "Huge File Upload Limits",
                    desc: "Process PDFs up to 1GB in size.",
                  },
                  {
                    title: "Zero Ads Experience",
                    desc: "100% clean and distraction-free workspace.",
                  },
                  {
                    title: "Fast Offline Processing",
                    desc: "Direct browser compilation at top speed.",
                  },
                  {
                    title: "Premium OCR Features",
                    desc: "Extract text from scanned PDFs offline.",
                  },
                  {
                    title: "24/7 Priority Mail Support",
                    desc: "Helpdesk access with VIP SLA.",
                  },
                ].map((feat, idx) => (
            ...
            <div className="bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200/60 dark:border-slate-800/80 rounded-3xl p-6 shadow-xl shadow-slate-100/50 dark:shadow-none space-y-5">
              <h2 className="text-base font-black tracking-tight text-zinc-800 dark:text-white flex items-center gap-2">
                <History size={16} className="text-indigo-500" /> Recent Tool
                Clicks
              </h2>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-2.5 min-w-0">
                          ...
                          <div className="min-w-0">
                            <p className="text-xs font-bold text-zinc-700 dark:text-zinc-200 truncate leading-snug">
                              {item.title}
                            </p>
                        ...
                        <ChevronRight
                          size={14}
                          className="text-slate-300 group-hover:text-slate-500 dark:group-hover:text-slate-400 group-hover:translate-x-0.5 transition-all flex-shrink-0"
                        />
                      </Link>
                    );
                  })
