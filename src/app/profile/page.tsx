...
export default function ProfilePage() {
 ...
 <span className="text-[10px] font-bold tracking-widest uppercase text-amber-600 dark:text-amber-400 flex items-center gap-1"><Award size={10} /> MEMBERSHIP</span>
 <span className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-purple-600 dark:from-amber-400 dark:to-purple-400 mt-1 uppercase">{userPlan}</span>
 <span className="text-[9px] font-bold text-zinc-500 dark:text-zinc-400 mt-0.5">{userPlan === "Basic Plan" ? "Upgrade for Pro Tools 🔓" : "All Pro Tools Unlocked 🔓"}</span>
 </div>
 </div>
 ...
 <p className="text-sm font-bold truncate max-w-[200px] text-zinc-800 dark:text-zinc-100">{profile?.full_name || "SmartPDFs VIP Member"}</p>
 </div>
 ...
 <div className="space-y-1">
 <p className="text-xs font-bold text-zinc-800 dark:text-zinc-200">Secure Database</p>
 ...
 <div className="space-y-1">
 <p className="text-xs font-bold text-zinc-800 dark:text-zinc-200">Auth Guarantee</p>
 <p className="text-[10px] text-zinc-500 dark:text-zinc-300 leading-normal">
 ...
 <p className="text-xs font-bold text-zinc-700 dark:text-zinc-200">{feat.title}</p>
 ...
 <p className="text-xs font-bold text-zinc-400 dark:text-zinc-500">No recent activity</p>
