...
const RepairTool = dynamic(() => import('@/components/tools/RepairTool'), {
  ssr: false,
  loading: () => <div className="container mx-auto px-4 max-w-7xl"><RepairSkeleton /></div>,
});
...
const STEPS = [
  {
    ...
    desc: 'Select one or more corrupted or damaged PDF files. Drop them into the workspace to get started.',
  },
  {
    icon: Wrench,
    title: 'Repair Automatically',
    desc: 'Our cloud repair engine analyses the file structure and recovers as much content as possible.',
  },
  {
    icon: Download,
    title: 'Download Repaired PDF',
    desc: 'Once repaired, download each file individually. Files are permanently deleted from our servers within 1 hour.',
  },
];
...
const RELATED_TOOLS = [
  ...
  },
  {
    id: 'protect',
    title: 'Protect PDF',
    description: 'Encrypt your repaired PDF with a password to keep it secure.',
    icon: Lock,
  ...
  },
  {
    id: 'unlock',
    title: 'Unlock PDF',
    description: 'Remove password protection from a PDF and restore full access.',
    icon: LifeBuoy,
