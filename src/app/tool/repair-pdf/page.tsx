          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto mb-12">
            {[
              ...
              },
              {
                ...
                title: "How to Compress a PDF Without Losing Quality (Best Free Tools)",
                iconBg: "bg-[#10b981]",
                readTime: "4 min read",
                date: "Apr 28, 2026",
              },
              {
                ...
                title: "The Ultimate Guide to PDF Optimization and Repair",
                iconBg: "bg-[#3b82f6]",
                readTime: "5 min read",
                date: "May 20, 2026",
              },
              ...
              <a key={post.slug} href={`/blog/${post.slug}`} className="group bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-lg transition-all overflow-hidden flex flex-col">
                  <div className="p-6 flex flex-col gap-3">
                      <div className="flex items-start gap-3">
                          <div className={`w-8 h-8 ${post.iconBg} rounded-lg flex items-center justify-center text-white shrink-0 mt-0.5`}>
                          ...
                          <h3 className="font-bold text-slate-800 dark:text-white text-[17px] leading-snug group-hover:text-red-600 transition-colors">
                              {post.title}
                          </h3>
                      </div>
