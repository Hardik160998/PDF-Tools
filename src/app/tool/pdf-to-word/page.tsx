...
import {
  ...
  Type, ImageIcon, Lock, CheckCircle, Shield, Zap, Info, ArrowRight,
...
export const metadata: Metadata = {
  ...
  description: 'Convert PDF documents to editable Microsoft Word files online for free. Highly accurate PDF to Word converter preserving fonts, tables, and layouts.',
  keywords: 'pdf to word, convert pdf to word, pdf to docx, convert pdf to docx, free pdf to word converter, pdf to editable word, online pdf converter, smartpdfs plus',
  alternates: {
...
const RELATED = [
  { id: 'word-to-pdf', title: 'Word to PDF', description: 'Convert DOCX files back to PDF with formatting perfectly preserved.', icon: FileText, gradient: 'linear-gradient(135deg, #3182ce, #1e3a8a)', shadow: 'rgba(49,130,206,0.3)', tag: 'Convert' },
...
function Breadcrumb() {
  return (
    <nav aria-label="Breadcrumb" className="mb-6 flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500">
      ...
      <span aria-hidden="true">/</span>
      <span className="text-slate-600 dark:text-slate-300" aria-current="page">PDF to Word</span>
    </nav>
  );
}
    ...
    <main className="min-h-screen bg-slate-50/50 dark:bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 sm:pt-12 pb-16">
        ...
        <section aria-label="Tool Benefits Quick Overview" className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
          {[
            { title: "Editable Word Output", desc: "Easily modify all text, fonts, tables, and layouts in standard DOCX format.", gradient: "linear-gradient(135deg,#3182ce,#1e3a8a)" },
            { title: "Safe & Secure Servers", desc: "Files are transferred over HTTPS and permanently deleted within 1 hour after conversion.", gradient: "linear-gradient(135deg,#3182ce,#1e3a8a)" },
            { title: "Fidelity Preservation", desc: "Our layout analyzer ensures that paragraphs, fonts, images, and sheets stay intact.", gradient: "linear-gradient(135deg,#22c55e,#15803d)" }
          ].map((feat, i) => (
        ...
        <section className="mt-20 border-t border-slate-200 dark:border-slate-800 pt-16 max-w-7xl mx-auto text-left">
          ...
          <div className="mb-16 text-center relative">
            ...
            <h1 className="text-4xl sm:text-6xl font-black tracking-tight mb-6 uppercase leading-tight bg-gradient-to-r from-slate-950 via-slate-800 to-blue-600 dark:from-white dark:via-slate-200 dark:to-blue-500 bg-clip-text text-transparent">
              ...
              <span className="text-blue-600 dark:text-blue-450">100% Free & Secure</span>
            </h1>
            <p className="text-base sm:text-lg text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed">
              Transform your non-editable PDF documents into fully customizable Microsoft Word (.docx) documents in seconds. 100% secure processing with automatic files deletion.
            </p>
          </div>
            ...
            <div className="bg-gradient-to-tr from-white to-slate-50/50 dark:from-slate-900 dark:to-slate-900/30 p-8 sm:p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed font-medium text-sm sm:text-base">
                  PDF (Portable Document Format) is designed to look identical across all computers, which makes it extremely hard to edit. PDF to Word conversion solves this by extracting textual structures, layout parameters, fonts, and inline tables from the PDF and converting them into an editable `.docx` Word file.
                </p>
                <p className="text-slate-500 dark:text-slate-400 leading-relaxed font-medium text-sm">
                  With SmartPDFs Plus, your conversion is executed on our isolated cloud servers via HTTPS. Your uploads are stored securely, handled by top-tier parser scripts to guarantee layout accuracy, and <strong className="text-blue-500 font-black">permanently wiped from our servers within 1 hour</strong>. You get a perfect editable layout without compromising your information privacy.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-8 sm:p-12 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 relative">
                ...
                {[
                  ...
                  { step: "02", title: "Wait for Conversion", desc: "Our high-speed cloud engine extracts the text styling, columns, table bounds, and graphics in seconds." },
                  { step: "03", title: "Download Word File", desc: "Save the generated editable DOCX file immediately. No watermark, fully compatible with MS Word." }
                ].map((s, idx) => (
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-gradient-to-br from-white to-slate-50/30 dark:from-slate-900 dark:to-slate-900/50 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col gap-4 group">
                  ...
                  <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight group-hover:text-green-500 transition-colors">Complete Data Protection</h3>
                  <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed font-medium">
                    We use military-grade HTTPS protocols to secure your files during upload and download. To keep your information clean and private, our system wipes your input and output files permanently after 1 hour.
                  </p>
                </div>
                <div className="bg-gradient-to-br from-white to-slate-50/30 dark:from-slate-900 dark:to-slate-900/50 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col gap-4 group">
                  ...
                  <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight group-hover:text-blue-500 transition-colors">Unmatched Layout Preservation</h3>
                  <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed font-medium">
                    Our analyzer correctly recognizes paragraph structures, headers, lists, columns, and tables, saving you from tedious manual layout rebuilding in Microsoft Word.
                  </p>
                </div>
              </div>
