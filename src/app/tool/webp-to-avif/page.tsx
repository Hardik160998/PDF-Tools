...
export const metadata: Metadata = {
  title: "Convert WebP to AVIF Online Free | Next-Gen Image Optimizer",
  description: "Convert WebP images to AVIF format online for free. AVIF provides next-generation compression that compresses files up to 35% smaller than WebP. 100% private.",
  keywords: "webp to avif, convert webp to avif, webp to avif converter, free image compressor, convert image to avif, online avif converter, local image conversion, smartpdfs",
  alternates: {
    canonical: `${siteUrl}/tool/webp-to-avif`,
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${siteUrl}/img/webp-to-avif-og.png`,
        width: 1200,
        height: 630,
        alt: "Convert WebP to AVIF Online - SmartPDFs Plus",
      },
    ],
  },
  twitter: {
    ...
    title: "Convert WebP to AVIF Online Free | Next-Gen Image Optimizer",
    description: "Convert WebP images to AVIF format online for free. AVIF provides next-generation compression that compresses files up to 35% smaller than WebP. 100% private.",
    images: [`${siteUrl}/img/webp-to-avif-og.png`],
  },
};
...
const webAppJsonLd = {
  ...
  "description": "Convert WebP images to AVIF format online for free. AVIF provides next-generation compression that compresses files up to 35% smaller than WebP.",
...
const STEPS = [
  ...
  { icon: SlidersHorizontal, title: "Auto Convert", desc: "Your WebP is converted to AVIF format instantly in your browser." },
  { icon: Download, title: "Download AVIF", desc: "Download the converted AVIF file — smaller and web-optimized." },
];

const RELATED = [
  { id: "avif-to-webp", title: "AVIF to WebP", description: "Convert AVIF images back to WebP format.", icon: ImageIcon, gradient: "linear-gradient(135deg, #14b8a6, #0f766e)", shadow: "rgba(20,184,166,0.3)", tag: "Image Convert" },
    ...
    <main className="min-h-screen bg-slate-50/50 dark:bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 sm:pt-12 pb-16">
        ...
        <nav aria-label="Breadcrumb" className="mb-6 flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500">
          ...
          <span aria-hidden="true">/</span>
          <span className="text-slate-600 dark:text-slate-300" aria-current="page">WebP to AVIF</span>
        </nav>

        {/* Dynamic Client Tool Component */}
        <section aria-label="WebP to AVIF Image Converter Application" className="mb-16">
        ...
        <section className="py-10">
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-cyan-50 to-sky-50 dark:from-cyan-900/10 dark:to-sky-900/10 border border-cyan-100 dark:border-cyan-800 rounded-3xl p-8">
              <h2 className="text-xl font-black text-slate-900 dark:text-white mb-4 text-center uppercase tracking-tight">WebP vs AVIF</h2>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
                {[
                  { stat: "~35%", label: "Smaller file size", sub: "vs standard WebP" },
        ...
        <section className="mt-20 border-t border-slate-200 dark:border-slate-800 pt-16 max-w-7xl mx-auto text-left">
          ...
          <div className="mb-16 text-center relative">
            ...
            <p className="text-base sm:text-lg text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed">
              Convert standard WebP graphics into lightweight next-generation AVIF formats. Optimize page loading benchmarks and enhance website SEO indexing with zero server uploads.
            </p>
          </div>
          ...
          <article className="space-y-16">
            ...
            <div className="bg-gradient-to-tr from-white to-slate-50/50 dark:from-slate-900 dark:to-slate-900/30 p-8 sm:p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed font-medium text-sm sm:text-base">
                  WebP offers extreme compression for web loading, but AVIF represents the next generational leap in compression technology. AVIF achieves lossless and lossy structures that are up to 35% smaller than standard WebP, leading to further improved page load speeds.
                </p>
                <p className="text-slate-500 dark:text-slate-400 leading-relaxed font-medium text-sm">
                  Converting WebP structures to AVIF is a critical SEO performance optimization. Our tool runs <strong className="text-cyan-500 font-black">entirely client-side inside your browser sandbox</strong>, meaning your files are never uploaded, stored, or processed on external servers.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-8 sm:p-12 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 relative">
                ...
                {[
                  { step: "01", title: "Select WebPs", desc: "Drag and drop WebP images directly into the converter box above." },
                  { step: "02", title: "Compress Automatically", desc: "The browser script converts the layout structures and processes WebP transparency to AVIF instantly." },
