...
export const metadata: Metadata = {
  ...
  description:
    "Convert JPG and JPEG images to WebP format online for free. Reduce file size up to 30% while retaining lossless visual details. 100% private in-browser conversion.",
  keywords:
    "jpg to webp, convert jpg to webp, jpeg to webp converter, free image optimizer, convert image to webp, online webp converter, local image conversion, smartpdfs",
  alternates: {
...
const STEPS = [
  ...
  },
  {
    ...
    title: "Auto Convert",
    desc: "Your image is converted to modern WebP format instantly in your browser.",
  },
  {
    icon: Download,
    title: "Download WebP",
...
const RELATED = [
  {
    ...
    title: "WebP to JPG",
    description:
      "Convert WebP images back to universally compatible JPG format.",
    icon: ImageIcon,
  ...
  return (
    <main className="min-h-screen bg-slate-50/50 dark:bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 sm:pt-12 pb-16">
        ...
        <section
          aria-label="JPG to WebP Image Converter Application"
          className="mb-16"
        >
        ...
        <section className="mt-20 border-t border-slate-200 dark:border-slate-800 pt-16 max-w-7xl mx-auto text-left">
          <div className="mb-16 text-center relative">
            ...
            <p className="text-base sm:text-lg text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed">
              Convert JPEG photographs to optimized next-generation WebP images.
              Enhance Core Web Vitals and reduce bundle load weights with our
              100% local browser converter tool.
            </p>
          </div>
            ...
            <div className="bg-gradient-to-tr from-white to-slate-50/50 dark:from-slate-900 dark:to-slate-900/30 p-8 sm:p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed font-medium text-sm sm:text-base">
                  WebP is a modern image standard created by Google that
                  delivers superior compression compared to legacy JPEG/JPG
                  structures. It features lossy and lossless algorithms that
                  produce files up to 30% smaller without sacrificing perceived
                  fidelity, dramatically improving website page loading speed.
                </p>
                <p className="text-slate-500 dark:text-slate-400 leading-relaxed font-medium text-sm">
                  Converting standard JPG images to WebP helps you achieve high
                  performance scores on Google Lighthouse. Since our tool
                  executes{" "}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 relative">
                ...
                {[
                  ...
                  },
                  {
                    ...
                    desc: "Our engine optimizes the character byte map to produce highly efficient WebP files in seconds.",
                  },
                  {
                    step: "03",
                    title: "Save and Optimize",
                    desc: "Download the converted WebP images individually, or export them altogether as a ZIP package.",
                  },
                ].map((s, idx) => (
                  <div
                    key={idx}
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-gradient-to-br from-white to-slate-50/30 dark:from-slate-900 dark:to-slate-900/50 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col gap-4 group">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed font-medium">
                    WebP helps websites render up to 3 times faster by reducing
