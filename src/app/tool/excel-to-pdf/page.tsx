...
export const metadata: Metadata = {
  ...
  keywords:
    "excel to pdf, xlsx to pdf, convert excel to pdf, free excel to pdf converter, online xlsx to pdf, smartpdfs plus",
  alternates: {
...
const RELATED = [
  {
    ...
    title: "PDF to Excel",
    description:
      "Extract tables from your PDF into an editable XLSX spreadsheet.",
            ...
            <div className="bg-gradient-to-tr from-white to-slate-50/50 dark:from-slate-900 dark:to-slate-900/30 p-8 sm:p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-500 dark:text-slate-400 leading-relaxed font-medium text-sm">
                  SmartPDFs Plus processes your sheets securely over HTTPS. Our
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {RELATED.map((t) => (
              ...
              >
                ...
                <div>
                  <h3 className="text-base font-black text-slate-900 dark:text-white mb-1 group-hover:text-green-500 transition-colors">
                    {t.title}
                  </h3>
                ...
                <div className="mt-auto pt-2 text-xs font-bold text-green-500 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
