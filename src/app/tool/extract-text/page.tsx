 ...
 <RelatedTools />
        ...
        <section className="mt-20 text-left">
          <div className="text-center max-w-3xl mx-auto mb-12">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 text-blue-600 border border-blue-100 text-xs font-medium uppercase tracking-widest shadow-sm mb-6">
          ...
          <div className="max-w-4xl mx-auto mb-12 grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Blog Post 1: OCR Guide */}
            <a href="/blog/what-is-ocr-and-how-to-convert-scanned-pdfs-to-text" className="group bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-lg transition-all overflow-hidden flex flex-col h-full">
                <div className="p-6 flex flex-col flex-1 gap-3">
                    <div className="flex items-start gap-3">
                        ...
                        <h3 className="font-bold text-slate-800 text-[17px] leading-snug group-hover:text-blue-600 transition-colors">
                            What is OCR? Convert Scanned PDF to Text Guide (2026)
                        </h3>
                    </div>
            ...
            {/* Blog Post 2: Extract Text Guide */}
            <a href="/blog/how-to-extract-text-from-scanned-documents-and-invoices" className="group bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-lg transition-all overflow-hidden flex flex-col h-full">
                <div className="p-6 flex flex-col flex-1 gap-3">
                    <div className="flex items-start gap-3">
                        <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center text-white shrink-0 mt-0.5">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                                <polyline points="14 2 14 8 20 8"></polyline>
                                <line x1="16" y1="13" x2="8" y2="13"></line>
                        ...
                        <h3 className="font-bold text-slate-800 text-[17px] leading-snug group-hover:text-blue-600 transition-colors">
                            Extract Text from Scanned Documents & Invoices (2026)
                        </h3>
                    </div>
                    <div className="flex items-center justify-between pt-4 mt-auto border-t border-slate-100">
                        <div className="flex items-center gap-1.5 text-xs text-slate-400 font-medium">
