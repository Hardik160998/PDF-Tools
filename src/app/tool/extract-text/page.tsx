    ...
    <div className="min-h-screen bg-slate-50/50 dark:bg-slate-950">
      <div className="max-w-7xl mx-auto px-4 pt-10 sm:pt-16 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 mb-16">
          {[
            { 
              title: "Raw Text Export", 
              desc: "Extract text directly from the PDF layer with high fidelity, preserving word order and whitespace.",
              gradient: "linear-gradient(135deg,#3b82f6,#2563eb)"
            },
            { 
              title: "Code Preview", 
              desc: "Instantly view extracted content in our built-in terminal-style editor with syntax highlighting.",
              gradient: "linear-gradient(135deg,#3b82f6,#2563eb)"
            },
            { 
              title: "Private Processing", 
              desc: "All document parsing happens locally. Your text never leaves your browser sandbox.",
