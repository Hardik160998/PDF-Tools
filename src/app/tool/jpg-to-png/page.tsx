...
export const metadata: Metadata = {
  title: "Convert JPG to PNG Online Free | Lossless Image Converter",
  description: "Convert JPG and JPEG images to PNG format instantly for free. Lossless quality conversion with alpha transparency support, operating 100% locally in your browser.",
  keywords: "jpg to png, convert jpg to png, jpeg to png converter, free image converter, convert image to png, online png converter, local image conversion, smartpdfs",
  alternates: {
    canonical: `${siteUrl}/tool/jpg-to-png`,
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${siteUrl}/img/jpg-to-png-og.png`,
        width: 1200,
        height: 630,
        alt: "Convert JPG to PNG Online - SmartPDFs Plus",
      },
    ],
  },
  twitter: {
    ...
    title: "Convert JPG to PNG Online Free | Lossless Image Converter",
    description: "Convert JPG and JPEG images to PNG format instantly for free. Lossless quality conversion with alpha transparency support, operating 100% locally in your browser.",
    images: [`${siteUrl}/img/jpg-to-png-og.png`],
  },
};
...
const webAppJsonLd = {
  ...
  "description": "Convert JPG and JPEG images to PNG format instantly for free. Lossless quality conversion with alpha transparency support.",
    ...
    <main className="min-h-screen bg-slate-50/50 dark:bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 sm:pt-12 pb-16">
        ...
        <nav aria-label="Breadcrumb" className="mb-6 flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500">
          ...
          <Link href="/tool" className="hover:text-emerald-500 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 rounded px-1">
            Tools
          </Link>
          <span aria-hidden="true">/</span>
          <span className="text-slate-600 dark:text-slate-300" aria-current="page">JPG to PNG</span>
        </nav>

        {/* Dynamic Client Tool Component */}
        <section aria-label="JPG to PNG Image Converter Application" className="mb-16">
        ...
        <section className="mt-20 border-t border-slate-200 dark:border-slate-800 pt-16 max-w-7xl mx-auto text-left">
          ...
          <div className="mb-16 text-center relative">
            ...
            <h1 className="text-4xl sm:text-6xl font-black tracking-tight mb-6 uppercase leading-tight bg-gradient-to-r from-slate-950 via-slate-800 to-emerald-600 dark:from-white dark:via-slate-200 dark:to-emerald-500 bg-clip-text text-transparent">
              ...
              <span className="text-emerald-500 dark:text-emerald-400">100% Free & Secure</span>
            </h1>
            <p className="text-base sm:text-lg text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed">
              Convert your JPEG images into PNG files instantly. Benefit from lossless conversion that supports transparency, completed entirely inside your browser for total file privacy.
            </p>
          </div>
          ...
          <article className="space-y-16">
            ...
            <div className="bg-gradient-to-tr from-white to-slate-50/50 dark:from-slate-900 dark:to-slate-900/30 p-8 sm:p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed font-medium text-sm sm:text-base">
                  JPG (Joint Photographic Experts Group) is a compressed lossy format ideal for digital photos but doesn't support transparent backgrounds. PNG (Portable Network Graphics) is a lossless format designed specifically for the web, supporting alpha channel transparency, crisp text, and solid vector-like elements.
                </p>
                <p className="text-slate-500 dark:text-slate-400 leading-relaxed font-medium text-sm">
                  Converting JPG images to PNG preserves existing image fidelity without adding extra compression compression noise. Since our tool operates <strong className="text-emerald-500 font-black">100% locally in your web browser</strong>, your personal snapshots, business charts, and confidential graphics never travel across any external servers.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-8 sm:p-12 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm">
              <h2 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tight mb-10 flex items-center gap-3">
                <span className="p-2 rounded-xl bg-emerald-500/10 text-emerald-500"><ArrowRight size={24} /></span>
                How to convert JPG to PNG in 3 Steps
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 relative">
                <div className="hidden md:block absolute top-6 left-[16%] right-[16%] h-0.5 bg-slate-100 dark:bg-slate-800/80 -z-0" />
                {[
                  { step: "01", title: "Select JPGs", desc: "Drag and drop your JPG or JPEG images directly into the converter box above." },
                  { step: "02", title: "Convert Automatically", desc: "Our offline browser engine converts the file structure to standard PNG format instantly." },
                  { step: "03", title: "Download Lossless", desc: "Save your new PNG images individually, or download all converted files as a batch ZIP." }
                ].map((s, idx) => (
                  <div key={idx} className="relative z-10 flex flex-col gap-4 group">
                    <div className="w-12 h-12 rounded-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center font-outfit text-lg font-black text-emerald-500 border-2 border-slate-100 dark:border-slate-800 shadow-sm group-hover:scale-110 group-hover:border-emerald-500/40 transition-all duration-300">
                      {s.step}
                    </div>
            ...
            <div className="space-y-8">
              <h2 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tight flex items-center gap-3">
                <span className="p-2 rounded-xl bg-emerald-500/10 text-emerald-500"><Star size={24} /></span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-gradient-to-br from-white to-slate-50/30 dark:from-slate-900 dark:to-slate-900/50 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col gap-4 group">
                  ...
                  <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight group-hover:text-green-500 transition-colors">Ironclad Device Security</h3>
                ...
                <div className="bg-gradient-to-br from-white to-slate-50/30 dark:from-slate-900 dark:to-slate-900/50 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col gap-4 group">
                  <div className="w-12 h-12 rounded-2xl bg-emerald-500/10 text-emerald-500 flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform duration-300"><Zap size={22} /></div>
                  <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight group-hover:text-emerald-500 transition-colors">Fast Lossless Conversion</h3>
                  <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed font-medium">
                    Convert image files instantly. There is no waiting for queue lines or file transmission. The output PNG preserves original resolution details faithfully.
                  </p>
                </div>
              </div>
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    <li key={idx} className="flex items-start gap-3 text-sm text-slate-600 dark:text-slate-400 font-medium">
                      <span className="p-0.5 rounded-full bg-emerald-500/10 text-emerald-600 mt-0.5 shrink-0"><Check size={12} /></span>
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>
            ...
            <div className="bg-white dark:bg-slate-900 p-8 sm:p-12 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm">
              <h2 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tight mb-8 flex items-center gap-3">
                <span className="p-2 rounded-xl bg-emerald-500/10 text-emerald-500"><HelpCircle size={24} /></span>
                ...
                {[
                  ...
                  >
                    <summary className="flex items-center justify-between cursor-pointer list-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 rounded-lg">
                      <h3 className="text-base sm:text-base font-black text-slate-800 dark:text-white uppercase tracking-tight group-hover:text-emerald-500 transition-colors pr-4">
                        {item.q}
                      </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {RELATED.map(t => (
              ...
              >
                ...
                <div>
                  <h3 className="text-base font-black text-slate-900 dark:text-white mb-1 group-hover:text-emerald-500 transition-colors">{t.title}</h3>
                  <p className="text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed">{t.description}</p>
                </div>
                <div className="mt-auto pt-2 text-xs font-bold text-emerald-500 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">Open tool <span aria-hidden="true">&#8594;</span></div>
              </Link>
            ))}
          </div>
        </section>
