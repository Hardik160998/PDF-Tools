...
export const metadata: Metadata = {
  ...
  description:
    "Convert JPG and JPEG images to PNG format instantly for free. Lossless quality conversion with alpha transparency support, operating 100% locally in your browser.",
  keywords:
    "jpg to png, convert jpg to png, jpeg to png converter, free image converter, convert image to png, online png converter, local image conversion, smartpdfs",
  alternates: {
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-gradient-to-br from-white to-slate-50/30 dark:from-slate-900 dark:to-slate-900/50 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col gap-4 group">
                  ...
                  <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight group-hover:text-emerald-500 transition-colors">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {RELATED.map((t) => (
              ...
              >
                ...
                <div>
                  <h3 className="text-base font-black text-slate-900 dark:text-white mb-1 group-hover:text-emerald-500 transition-colors">
                    {t.title}
                  </h3>
