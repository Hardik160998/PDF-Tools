...
const MergeSplit = dynamic(() => import('@/components/tools/MergeSplit'), {
  ssr: false,
  loading: () => <div className="container mx-auto px-4 max-w-7xl"><MergeSplitSkeletonA /></div>,
});
...
const STEPS = [
  {
    ...
    desc: 'Select the PDF file you want to split. Any size works — processed entirely in your browser.',
  },
  {
    icon: Settings,
    title: 'Choose Split Mode',
    desc: 'Divide into 2, 3, or 4 equal parts — or extract every single page as its own PDF file.',
  },
  {
    icon: Download,
    title: 'Download ZIP',
    desc: 'Click "Split PDF" and download a ZIP archive containing all your split PDF files instantly.',
  },
];
...
const RELATED_TOOLS = [
  {
    id: 'merge',
    title: 'Merge PDF',
    description: 'Combine multiple PDF files back into one document in the order you choose.',
    icon: Combine,
  ...
  },
  {
    id: 'protect',
    title: 'Protect PDF',
    description: 'Encrypt your split PDFs with a password to keep them secure.',
    icon: Lock,
