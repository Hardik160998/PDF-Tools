        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 mb-16">
          {[
            { 
              ...
              desc: "Extract every page of your PDF into separate individual files with a single click.",
              gradient: "linear-gradient(135deg,#8b5cf6,#6d28d9)"
            },
            { 
              title: "Part Division", 
              desc: "Divide large documents into equal parts (e.g., 2, 3, or 4 files) for easier sharing.",
              gradient: "linear-gradient(135deg,#8b5cf6,#6d28d9)"
            },
            { 
              title: "Instant Download", 
              desc: "Split files are bundled into a clean ZIP archive for organized batch downloading.",
