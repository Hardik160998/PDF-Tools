...
export const metadata: Metadata = {
  ...
  description: "Convert PNG images to WebP format online for free. Compress and convert images to WebP up to 25% smaller while preserving alpha transparency. 100% private.",
  keywords: "png to webp, convert png to webp, png to webp converter, free image compressor, convert image to webp, online webp converter, local image conversion, smartpdfs",
  alternates: {
...
const webAppJsonLd = {
  ...
  "description": "Convert PNG images to WebP format online for free. Compress and convert images to WebP up to 25% smaller while preserving alpha transparency.",
    ...
    <main className="min-h-screen bg-slate-50/50 dark:bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 sm:pt-12 pb-16">
        ...
        <nav aria-label="Breadcrumb" className="mb-6 flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500">
          ...
          <span aria-hidden="true">/</span>
          <span className="text-slate-600 dark:text-slate-300" aria-current="page">PNG to WebP</span>
        </nav>

        {/* Dynamic Client Tool Component */}
        <section aria-label="PNG to WebP Image Converter Application" className="mb-16">
        ...
        <section className="py-10">
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-cyan-50 to-sky-50 dark:from-cyan-900/10 dark:to-sky-900/10 border border-cyan-100 dark:border-cyan-800 rounded-3xl p-8">
              <h2 className="text-xl font-black text-slate-900 dark:text-white mb-4 text-center uppercase tracking-tight">PNG vs WebP</h2>
        ...
        <section className="mt-20 border-t border-slate-200 dark:border-slate-800 pt-16 max-w-7xl mx-auto text-left">
          ...
          <div className="mb-16 text-center relative">
            ...
            <p className="text-base sm:text-lg text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed">
              Convert transparent or solid PNG graphics into lightweight next-generation WebP formats. Optimize page loading benchmarks and enhance website SEO indexing with zero server uploads.
            </p>
          </div>
            ...
            <div className="bg-gradient-to-tr from-white to-slate-50/50 dark:from-slate-900 dark:to-slate-900/30 p-8 sm:p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed font-medium text-sm sm:text-base">
                  PNG is the web standard for transparency, but files are often unnecessarily large. WebP achieves lossless and lossy structures that are much smaller while maintaining identical alpha transparencies and vector definitions, leading to improved page load speeds.
                </p>
                <p className="text-slate-500 dark:text-slate-400 leading-relaxed font-medium text-sm">
                  Converting PNG structures to WebP is a critical SEO performance optimization. Our tool runs <strong className="text-cyan-500 font-black">entirely client-side inside your browser sandbox</strong>, meaning your files are never uploaded, stored, or processed on external servers.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-8 sm:p-12 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 relative">
                ...
                {[
                  ...
                  { step: "02", title: "Compress Automatically", desc: "The browser script converts the layout structures and processes PNG transparency to WebP instantly." },
                  { step: "03", title: "Download WebP", desc: "Export the lightweight WebP files individually or as a single batch ZIP file." }
                ].map((s, idx) => (
