...
export default function JpgToAvifPage() {
 ...
 <h3 className="text-base sm:text-base font-bold text-slate-800 dark:text-white uppercase tracking-tight group-hover:text-fuchsia-500 transition-colors pr-4">
 {item.q}
 </h3>
