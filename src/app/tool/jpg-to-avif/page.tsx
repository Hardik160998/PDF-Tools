...
export const metadata: Metadata = {
  title: "Convert JPG to AVIF Online Free | Next-Gen Image Converter",
  description: "Convert JPG and JPEG images to AVIF format online for free. AVIF offers the next-generation of compression, yielding files up to 50% smaller than JPG. 100% private.",
  keywords: "jpg to avif, convert jpg to avif, jpeg to avif converter, free avif converter, convert image to avif, online avif converter, local image conversion, smartpdfs",
  alternates: {
    canonical: `${siteUrl}/tool/jpg-to-avif`,
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${siteUrl}/img/jpg-to-avif-og.png`,
        width: 1200,
        height: 630,
        alt: "Convert JPG to AVIF Online - SmartPDFs Plus",
      },
    ],
  },
  twitter: {
    ...
    title: "Convert JPG to AVIF Online Free | Next-Gen Image Converter",
    description: "Convert JPG and JPEG images to AVIF format online for free. AVIF offers the next-generation of compression, yielding files up to 50% smaller than JPG. 100% private.",
    images: [`${siteUrl}/img/jpg-to-avif-og.png`],
  },
};
...
const webAppJsonLd = {
  ...
  "description": "Convert JPG and JPEG images to AVIF format online for free. AVIF offers next-generation compression for lightweight web graphics.",
...
const STEPS = [
  ...
  { icon: SlidersHorizontal, title: "Auto Convert", desc: "Your image is converted to modern AVIF format instantly in your browser." },
  { icon: Download, title: "Download AVIF", desc: "Download the converted AVIF file immediately — ultra-compressed and web-ready." },
];
...
const RELATED = [
  ...
  { id: "png-to-avif", title: "PNG to AVIF", description: "Convert PNG images to AVIF for smaller sizes with transparency support.", icon: ImageIcon, gradient: "linear-gradient(135deg, #06b6d4, #0e7490)", shadow: "rgba(6,182,212,0.3)", tag: "Image Convert" },
    ...
    <main className="min-h-screen bg-slate-50/50 dark:bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 sm:pt-12 pb-16">
        ...
        <nav aria-label="Breadcrumb" className="mb-6 flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500">
          <Link href="/" className="hover:text-fuchsia-500 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fuchsia-500 rounded px-1">
            Home
          </Link>
          <span aria-hidden="true">/</span>
          <Link href="/tool" className="hover:text-fuchsia-500 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fuchsia-500 rounded px-1">
            Tools
          </Link>
          <span aria-hidden="true">/</span>
          <span className="text-slate-600 dark:text-slate-300" aria-current="page">JPG to AVIF</span>
        </nav>

        {/* Dynamic Client Tool Component */}
        <section aria-label="JPG to AVIF Image Converter Application" className="mb-16">
        ...
        <section className="py-10">
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-fuchsia-50 to-pink-50 dark:from-fuchsia-900/10 dark:to-pink-900/10 border border-fuchsia-100 dark:border-fuchsia-800/60 rounded-3xl p-8">
              <h2 className="text-xl font-black text-slate-900 dark:text-white mb-4 text-center uppercase tracking-tight">Why Convert to AVIF?</h2>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
                {[
                  { stat: "~50%", label: "Smaller than JPG", sub: "Same visual quality" },
                  { stat: "~35%", label: "Smaller than WebP", sub: "Next-gen compression format" },
                  { stat: "100%", label: "Browser Support", sub: "All modern browsers" },
                ].map(({ stat, label, sub }) => (
                  <div key={label} className="space-y-1">
                    <div className="text-3xl font-black text-fuchsia-600 dark:text-fuchsia-400">{stat}</div>
        ...
        <section className="mt-20 border-t border-slate-200 dark:border-slate-800 pt-16 max-w-7xl mx-auto text-left">
          ...
          <div className="mb-16 text-center relative">
            ...
            <h1 className="text-4xl sm:text-6xl font-black tracking-tight mb-6 uppercase leading-tight bg-gradient-to-r from-slate-950 via-slate-800 to-fuchsia-600 dark:from-white dark:via-slate-200 dark:to-fuchsia-500 bg-clip-text text-transparent">
              ...
              <span className="text-fuchsia-500 dark:text-fuchsia-400">100% Free & Secure</span>
            </h1>
            <p className="text-base sm:text-lg text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed">
              Convert JPG pictures to next-generation AVIF images. Yield files up to 50% smaller while keeping the same visual quality. 100% client-side in-browser tool.
            </p>
          </div>
          ...
          <article className="space-y-16">
            ...
            <div className="bg-gradient-to-tr from-white to-slate-50/50 dark:from-slate-900 dark:to-slate-900/30 p-8 sm:p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed font-medium text-sm sm:text-base">
                  AVIF (AV1 Image File Format) is the next-generation image format that represents the biggest leap in compression technology since WebP. Built on open source standards, AVIF files can compress up to 50% smaller than legacy JPG files, dramatically improving Core Web Vitals and LCP loading speeds.
                </p>
                <p className="text-slate-500 dark:text-slate-400 leading-relaxed font-medium text-sm">
                  Converting standard JPG images to AVIF helps your site load faster. Since our tool executes <strong className="text-fuchsia-500 font-black">100% client-side inside your browser</strong>, your proprietary graphs, charts, and digital photo layouts are protected locally on your device hardware.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-8 sm:p-12 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm">
              <h2 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tight mb-10 flex items-center gap-3">
                <span className="p-2 rounded-xl bg-fuchsia-500/10 text-fuchsia-500"><ArrowRight size={24} /></span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 relative">
                ...
                {[
                  ...
                  { step: "02", title: "Compress Instantly", desc: "Our engine optimizes the character byte map to produce highly efficient AVIF files in seconds." },
                  { step: "03", title: "Save and Optimize", desc: "Download the converted AVIF images individually, or export them altogether as a ZIP package." }
                ].map((s, idx) => (
                  <div key={idx} className="relative z-10 flex flex-col gap-4 group">
                    <div className="w-12 h-12 rounded-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center font-outfit text-lg font-black text-fuchsia-500 border-2 border-slate-100 dark:border-slate-800 shadow-sm group-hover:scale-110 group-hover:border-fuchsia-500/40 transition-all duration-300">
                      {s.step}
                    </div>
            ...
            <div className="space-y-8">
              <h2 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tight flex items-center gap-3">
                <span className="p-2 rounded-xl bg-fuchsia-500/10 text-fuchsia-500"><Star size={24} /></span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-gradient-to-br from-white to-slate-50/30 dark:from-slate-900 dark:to-slate-900/50 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col gap-4 group">
                  <div className="w-12 h-12 rounded-2xl bg-fuchsia-500/10 text-fuchsia-500 flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform duration-300"><Zap size={22} /></div>
                  <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight group-hover:text-fuchsia-500 transition-colors">Accelerate Page Load Speeds</h3>
                  <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed font-medium">
                    AVIF helps websites render up to 5 times faster by reducing image transfer payloads without degrading visually perceptible quality.
                  </p>
                </div>
              </div>
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    <li key={idx} className="flex items-start gap-3 text-sm text-slate-600 dark:text-slate-400 font-medium">
                      <span className="p-0.5 rounded-full bg-fuchsia-500/10 text-fuchsia-600 mt-0.5 shrink-0"><Check size={12} /></span>
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>
            ...
            <div className="bg-white dark:bg-slate-900 p-8 sm:p-12 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm">
              <h2 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white uppercase tracking-tight mb-8 flex items-center gap-3">
                <span className="p-2 rounded-xl bg-fuchsia-500/10 text-fuchsia-500"><HelpCircle size={24} /></span>
                ...
                {[
                  ...
                  >
                    <summary className="flex items-center justify-between cursor-pointer list-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fuchsia-500 rounded-lg">
                      <h3 className="text-base sm:text-base font-black text-slate-800 dark:text-white uppercase tracking-tight group-hover:text-fuchsia-500 transition-colors pr-4">
                        {item.q}
                      </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {RELATED.map(t => (
              ...
              >
                ...
                <div>
                  <h3 className="text-base font-black text-slate-900 dark:text-white mb-1 group-hover:text-fuchsia-500 transition-colors">{t.title}</h3>
                  <p className="text-sm text-slate-500 dark:text-slate-400 font-medium leading-relaxed">{t.description}</p>
                </div>
                <div className="mt-auto pt-2 text-xs font-bold text-fuchsia-500 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">Open tool <span aria-hidden="true">&#8594;</span></div>
              </Link>
            ))}
          </div>
        </section>
