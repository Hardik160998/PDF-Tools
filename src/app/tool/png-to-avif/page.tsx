...
export const metadata: Metadata = {
  ...
  description:
    "Convert PNG images to AVIF format online for free. Compress and convert images to AVIF up to 35% smaller while preserving alpha transparency. 100% private.",
  keywords:
    "png to avif, convert png to avif, png to avif converter, free image compressor, convert image to avif, online avif converter, local image conversion, smartpdfs",
  alternates: {
