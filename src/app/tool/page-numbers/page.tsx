...
import {
  Hash, Upload, AlignRight, Download, Stamp, Settings, Lock, Unlock,
...
export const metadata: Metadata = {
  ...
  description: 'Add professional page numbers to your PDF documents automatically online for free. Customize font, size, position, and 100% secure local browser processing.',
  keywords: 'add page numbers to pdf, page numbers pdf, pdf page numbering tool, insert page numbers pdf, free pdf numbering, smartpdfs plus',
  alternates: {
    canonical: `${siteUrl}/tool/page-numbers`,
  },
  robots: {
    index: true,
    follow: true,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Add Page Numbers to PDF Online - SmartPDFs Plus',
      },
    ],
  },
  twitter: {
...
function Breadcrumb() {
  return (
    <nav aria-label="Breadcrumb" className="mb-6 flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500">
      ...
      <span aria-hidden="true">/</span>
      <span className="text-slate-600 dark:text-slate-300" aria-current="page">Page Numbers</span>
    </nav>
  );
}
    ...
    <main className="min-h-screen bg-slate-50/50 dark:bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 sm:pt-12 pb-16">
        ...
        <section aria-label="Tool Benefits Quick Overview" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-20 animate-fade-in">
          {[
            { title: 'Number Placement', desc: 'Add page numbers to your PDF at any corner or header/footer boundary cleanly.', icon: Hash },
            { title: '100% Offline', desc: 'Numbering is executed client-side in browser JS. Your files never touch a server.', icon: Shield },
            { title: 'Flexible Styling', desc: 'Fidelity is fully preserved. Fine-tune layout margins, start index, and ranges.', icon: Settings },
        ...
        <section className="mt-20 border-t border-slate-200 dark:border-slate-800 pt-16 max-w-7xl mx-auto text-left">
          ...
          <div className="mb-16 text-center relative">
            ...
            <h1 className="text-4xl sm:text-6xl font-black tracking-tight mb-6 uppercase leading-tight bg-gradient-to-r from-slate-950 via-slate-800 to-indigo-600 dark:from-white dark:via-slate-200 dark:to-indigo-500 bg-clip-text text-transparent">
              ...
              <span className="text-indigo-500 dark:text-indigo-450">Free, Fast & Secure</span>
            </h1>
            <p className="text-base sm:text-lg text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed">
              Insert page numbers into your PDF documents in seconds. Process everything inside your web browser — no files are uploaded to any server.
            </p>
          </div>
            ...
            <div className="bg-gradient-to-tr from-white to-slate-50/50 dark:from-slate-900 dark:to-slate-900/30 p-8 sm:p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed font-medium text-sm sm:text-base">
                  PDF page numbering is the process of embedding sequence numbers (such as Page 1, 2, 3 or document section numbering) into the layout of PDF documents. Page numbers are crucial for organizing printouts, legal brief compliance, corporate filing protocols, and academic layouts.
                </p>
                <p className="text-slate-500 dark:text-slate-400 leading-relaxed font-medium text-sm">
                  With SmartPDFs Plus, your numbering is executed <strong className="text-indigo-550 font-black">100% locally in your web browser</strong> using native JavaScript libraries. Your files never touch our servers, guaranteeing complete document privacy and instant offline stamp execution.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-8 sm:p-12 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 relative">
                ...
                {[
                  ...
                  { step: "02", title: "Set Positions", desc: "Select number styles, align top/bottom borders, define margins, and choose target page indexes." },
                  { step: "03", title: "Apply & Download", desc: "Click Apply Page Numbers and download your numbered PDF instantly. Ready to share." }
                ].map((s, idx) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-gradient-to-br from-white to-slate-50/30 dark:from-slate-900 dark:to-slate-900/50 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col gap-4 group">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed font-medium">
                    Security is our baseline. Our tool works locally inside your browser sandbox. It reads and numbers the PDFs directly in your computer's memory, so your files are never transmitted across the internet.
                  </p>
                </div>
                <div className="bg-gradient-to-br from-white to-slate-50/30 dark:from-slate-900 dark:to-slate-900/50 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col gap-4 group">
                  ...
                  <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight group-hover:text-indigo-500 transition-colors">Flexible Spacing Formats</h3>
                  <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed font-medium">
                    Select number alignments, starting indexes, formatting boundaries, and exclude specific cover layouts from page numbering.
                  </p>
                </div>
              </div>
                ...
                {[
                  ...
                  >
                    <summary className="flex items-center justify-between cursor-pointer list-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded-lg">
                      <h3 className="text-base sm:text-base font-black text-slate-800 dark:text-white uppercase tracking-tight group-hover:text-indigo-500 transition-colors pr-4">
                        {item.q}
                      </h3>
