...
export const metadata: Metadata = {
  ...
  description:
    "Convert PNG images to JPG format online for free. Compress and convert images to lightweight JPGs instantly. 100% secure client-side browser processing.",
  keywords:
    "png to jpg, convert png to jpg, png to jpeg converter, free png to jpg, convert image to jpg, online jpg converter, local image conversion, smartpdfs",
  alternates: {
