...
const FEATURES = ['Removes password protection','Restores full PDF access','Works on owner-locked PDFs','Powered by cloud engine','Files deleted within 1 hour','Encrypted HTTPS transfer'];
const STEPS = [
    ...
    <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #fff7ed33 0%, #fff0 50%, #ffedd533 100%)' }}>
      <section className="pt-16 pb-8 text-center">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-50 text-orange-600 border border-orange-100 text-xs font-black uppercase tracking-widest shadow-sm mb-6"><Unlock size={13} /> Free PDF Unlock Tool</div>
          <h1 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tight leading-tight mb-5">Unlock Password-Protected PDF{' '}<span style={{ background: 'linear-gradient(135deg, #f97316, #c2410c)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Instantly</span></h1>
          <p className="text-lg text-slate-500 font-medium leading-relaxed max-w-2xl mx-auto mb-8">Remove password protection from any PDF you own. Enter the current password, unlock it, and download a fully accessible PDF — free to use however you need.</p>
