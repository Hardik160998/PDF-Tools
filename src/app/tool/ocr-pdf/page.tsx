...
export const metadata: Metadata = {
  title: 'OCR PDF Online Free - Convert Scans to Searchable PDF | SmartPDFs',
  description: 'OCR PDF files online for free. Convert scanned PDFs and images into fully searchable, selectable PDF documents. 100% secure, local in-browser OCR scanning.',
  keywords: 'ocr pdf, pdf ocr online, searchable pdf converter, convert scanned pdf to selectable text, free ocr pdf, local pdf ocr, smartpdfs',
  alternates: {
    canonical: `${siteUrl}/tool/ocr-pdf`,
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${siteUrl}/img/ocr-pdf-og.png`,
        width: 1200,
        height: 630,
        alt: 'OCR PDF Online Free - SmartPDFs',
      },
    ],
  },
  twitter: {
    ...
    title: 'OCR PDF Online Free - Convert Scans to Searchable PDF | SmartPDFs',
    description: 'OCR PDF files online for free. Convert scanned PDFs and images into fully searchable, selectable PDF documents. 100% secure, local in-browser OCR scanning.',
    images: [`${siteUrl}/img/ocr-pdf-og.png`],
  },
};
        ...
        <article className="space-y-16 max-w-7xl mx-auto mt-20">
          ...
          <section className="space-y-10">
            <div className="text-center space-y-2">
              ...
              <p className="text-sm font-medium text-slate-400 uppercase tracking-wider">Step-by-step character recognition guide</p>
            </div>
          ...
          <section className="bg-gradient-to-tr from-white to-blue-50/20 dark:from-slate-900 dark:to-slate-950 p-8 sm:p-12 rounded-[2.5rem] border border-blue-100/50 dark:border-slate-800/80 space-y-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: "No Data Uploads", desc: "Scan and build layers inside your browser sandbox. 100% confidential, secure, and private." },
                { title: "Searchable Layer Injected", desc: "Injects an invisible text overlay exactly matching original scans, enabling search." },
                { title: "Preserves Scans Layout", desc: "Text is positioned dynamically at original coordinate positions, matching images." },
                { title: "Extract Text Sister", desc: "Need raw text blocks only? Use our Extract Text tool to parse characters instantly." }
              ].map((feat, i) => (
          ...
          <section className="space-y-8 max-w-4xl mx-auto">
            <div className="text-center space-y-2">
              ...
              <p className="text-sm font-medium text-slate-400 uppercase tracking-wider">OCR PDF FAQs</p>
            </div>
          ...
          <section className="pt-10 border-t border-slate-100 dark:border-slate-800/80">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                { name: "PDF to XML", path: "/tool/pdf-to-xml", desc: "Format structured XML tags" },
