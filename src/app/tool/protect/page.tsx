...
const FEATURES = [
  ...
  'Restricts opening & printing',
  'Works on any PDF',
  'Powered by cloud security',
...
const RELATED_TOOLS = [
  { id: 'unlock', title: 'Unlock PDF', description: 'Remove password protection from a PDF you own and restore full access.', icon: Unlock, gradient: 'linear-gradient(135deg, #f97316, #c2410c)', shadow: 'rgba(249,115,22,0.3)', tag: 'Security' },
      ...
      <section className="pt-16 pb-8 text-center">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-50 text-red-600 border border-red-100 text-xs font-black uppercase tracking-widest shadow-sm mb-6">
            <Lock size={13} /> Free PDF Protect Tool
          </div>
          <h1 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tight leading-tight mb-5">
            Password Protect Your PDF{' '}
            <span style={{ background: 'linear-gradient(135deg, #ef4444, #b91c1c)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Securely</span>
          </h1>
          <p className="text-lg text-slate-500 font-medium leading-relaxed max-w-2xl mx-auto mb-8">
            Encrypt any PDF with a password to control who can open it. Set a strong password and share your document with confidence — only authorised users can access it.
          </p>
