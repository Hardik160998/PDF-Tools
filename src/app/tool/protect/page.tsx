...
export const metadata: Metadata = {
  title: 'Protect PDF Online Free | Password Protect PDF Files',
  description: 'Protect PDF files online for free. Encrypt your PDF document with a strong password to prevent unauthorized opening, editing, copying, or printing.',
  keywords: 'protect pdf, password protect pdf, encrypt pdf file, secure pdf online, add password to pdf, lock pdf file, smartpdfs plus',
  alternates: {
    canonical: `${siteUrl}/tool/protect`,
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    type: 'website',
    title: 'Protect PDF Online Free | Secure PDF Encrypter',
    description: 'Encrypt your PDF with a strong password to control access. Secure your documents with military-grade encryption in seconds.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Password Protect PDF Documents Online - SmartPDFs Plus',
      },
    ],
  },
  twitter: {
...
const webAppJsonLd = {
  ...
  "description": "Password protect and encrypt PDF files online. Secure documents with strong AES encryption to control editing, printing, and copying.",
...
function Breadcrumb() {
  return (
    <nav aria-label="Breadcrumb" className="mb-6 flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500">
      ...
      <span aria-hidden="true">/</span>
      <span className="text-slate-600 dark:text-slate-300" aria-current="page">Protect PDF</span>
    </nav>
  );
}
    ...
    <main className="min-h-screen bg-slate-50/50 dark:bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 sm:pt-12 pb-16">
        ...
        <section aria-label="Tool Benefits Quick Overview" className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
          {[
            { title: "Military-Grade AES", desc: "Lock your PDF with 128-bit or 256-bit AES encryption schemas. Make files completely secure.", gradient: "linear-gradient(135deg,#ef4444,#b91c1c)" },
            { title: "Granular Controls", desc: "Prevent unauthorized users from editing, copying text, or printing your PDF content.", gradient: "linear-gradient(135deg,#ef4444,#b91c1c)" },
            { title: "Safe Deletion Rules", desc: "All documents processed on our servers are permanently deleted within 1 hour.", gradient: "linear-gradient(135deg,#10b981,#047857)" }
          ].map((feat, i) => (
        ...
        <section className="mt-20 border-t border-slate-200 dark:border-slate-800 pt-16 max-w-7xl mx-auto text-left">
          ...
          <div className="mb-16 text-center relative">
            ...
            <h1 className="text-4xl sm:text-6xl font-black tracking-tight mb-6 uppercase leading-tight bg-gradient-to-r from-slate-950 via-slate-800 to-red-650 dark:from-white dark:via-slate-200 dark:to-red-500 bg-clip-text text-transparent">
              ...
              <span className="text-red-500 dark:text-red-400">100% Free & Secure</span>
            </h1>
            <p className="text-base sm:text-lg text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed">
              Encrypt your PDF documents to protect sensitive records, financial sheets, and confidential information from unauthorized opening, modification, or copying.
            </p>
          </div>
          ...
          <article className="space-y-16">
            ...
            <div className="bg-gradient-to-tr from-white to-slate-50/50 dark:from-slate-900 dark:to-slate-900/30 p-8 sm:p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed font-medium text-sm sm:text-base">
                  PDF Protection is the process of applying encryption parameters to a PDF document to restrict viewing or editing permissions. By embedding password strings into the document header structure, you ensure that only recipients with the authorized key can decrypt and display the contents.
                </p>
                <p className="text-slate-500 dark:text-slate-400 leading-relaxed font-medium text-sm">
                  Our encrypter integrates advanced AES cryptographic logic to build robust passwords into your PDF files. This security applies to any standard reader (Adobe Acrobat, Chrome/Firefox, Apple Preview), guaranteeing <strong className="text-red-500 font-black">complete compliance and confidentiality</strong> across all systems.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-8 sm:p-12 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 relative">
                ...
                {[
                  { step: "01", title: "Select PDF", desc: "Select or drop the PDF document you wish to encrypt into the workspace above." },
                  { step: "02", title: "Configure Password", desc: "Type in a strong password. Be sure to memorize it so you can open the file later." },
                  { step: "03", title: "Encrypt & Download", desc: "Click the add password action to encrypt the file, then download the locked document." }
                ].map((s, idx) => (
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-gradient-to-br from-white to-slate-50/30 dark:from-slate-900 dark:to-slate-900/50 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col gap-4 group">
                  <div className="w-12 h-12 rounded-2xl bg-green-500/10 text-green-500 flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform duration-300"><Lock size={22} /></div>
                  <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight group-hover:text-green-500 transition-colors">Robust AES Encryption</h3>
                  <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed font-medium">
                    Lock down your sensitive reports, statements, or contracts using highly secure, industrial standard cryptographic algorithms.
                  </p>
                </div>
                <div className="bg-gradient-to-br from-white to-slate-50/30 dark:from-slate-900 dark:to-slate-900/50 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col gap-4 group">
                  <div className="w-12 h-12 rounded-2xl bg-red-500/10 text-red-500 flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform duration-300"><Unlock size={22} /></div>
                  <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight group-hover:text-red-500 transition-colors">Comprehensive Restrictions</h3>
                  <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed font-medium">
                    Control viewer authorization. Encrypted PDFs prevent users from extracting, editing, or printing text unless they have the password.
                  </p>
                </div>
              </div>
