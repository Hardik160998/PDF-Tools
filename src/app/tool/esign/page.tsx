...
const RELATED = [
 ...
 title: "Watermark PDF",
 description:
 "Stamp a text or image watermark over your PDF. Set transparency and positions.",
 icon: Stamp,
 ...
 title: "Page Numbers",
 description:
 "Add professional page numbers to your PDF. Choose position and layout styling.",
 icon: FileDigit,
 ...
 title: "Protect PDF",
 description:
 "Encrypt your PDF with a password. Control access permissions.",
 icon: Lock,
 ...
 title: "Unlock PDF",
 description:
 "Remove password restrictions from your PDF and restore full access.",
 icon: Unlock,
...
function ESignSkeleton() {
 ...
 return meta ? (
 <>
 <WebAppSchema name={`${meta.title} – Free Online Tool`} description={meta.description} url={getToolUrl('esign')} />
 {meta.faqs.length > 0 && <FAQSchema faqs={meta.faqs} />}
 <BreadcrumbSchema items={[{ label: 'Tools', href: '/#tools' }, { label: meta.title, href: `/tool/esign` }]} />
 </>
 ) : null;
 })()}
...
export default function ESignPage() {
 ...
 <h3 className="text-base sm:text-base font-bold text-slate-800 dark:text-white uppercase tracking-tight group-hover:text-violet-500 transition-colors pr-4">
 {item.q}
 </h3>
 ...
 <div>
 <h3 className="text-base font-bold text-slate-900 dark:text-white mb-1 group-hover:text-violet-500 transition-colors">
 {t.title}
 </h3>
