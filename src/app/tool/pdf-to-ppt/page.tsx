...
import { Presentation, Upload, Sparkles, Download, FileText, FileSpreadsheet, Globe, Type, Lock, Zap, CheckCircle } from 'lucide-react';
...
const FEATURES = [
  'Converts PDF to editable PPTX',
  'Each page becomes a slide',
  'Images & text preserved',
...
const STEPS = [
  ...
  { icon: Download, title: 'Download PPTX', desc: 'Your presentation is ready to download and edit in PowerPoint or Google Slides instantly.' },
];
      ...
      <section className="pt-16 pb-8 text-center">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-50 text-orange-600 border border-orange-100 text-xs font-black uppercase tracking-widest shadow-sm mb-6">
            <Presentation size={13} /> Free PDF to PowerPoint Tool
          </div>
          <h1 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tight leading-tight mb-5">
            Convert PDF to PowerPoint{' '}
            <span style={{ background: 'linear-gradient(135deg, #f97316, #c2410c)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Editable PPTX</span>
          </h1>
          <p className="text-lg text-slate-500 font-medium leading-relaxed max-w-2xl mx-auto mb-8">
            Convert any PDF into an editable PowerPoint presentation. Each page becomes a slide — ready to edit, redesign, and present in Microsoft PowerPoint or Google Slides.
          </p>
