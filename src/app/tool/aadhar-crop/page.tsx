...
export default function AadharCropPage() {
 ...
 <h3 className="text-xl font-bold text-slate-900 dark:text-white uppercase tracking-tight mb-2">{s.title}</h3>
 ...
 <h3 className="text-xl font-bold text-slate-900 dark:text-white uppercase tracking-tight group-hover:text-green-500 transition-colors">100% Local Processing</h3>
 ...
 <h3 className="text-xl font-bold text-slate-900 dark:text-white uppercase tracking-tight group-hover:text-red-500 transition-colors">Accurate ID Dimensions</h3>
 <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed font-medium">
 ...
 <div>
 <h3 className="text-base font-bold text-slate-900 dark:text-white mb-1 group-hover:text-red-500 transition-colors">{t.title}</h3>
