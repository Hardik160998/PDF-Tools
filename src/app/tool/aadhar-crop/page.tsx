...
export const metadata: Metadata = {
  ...
  description:
    "Crop your e-Aadhar card PDF or image online for free. Adjust and crop the front and back sides to standard ID dimensions ready for print. 100% private.",
  keywords:
    "aadhar crop, crop aadhar card, online aadhar cropper, e-aadhar cropper, print ready aadhar card, crop id card online, local image conversion, smartpdfs",
  alternates: {
...
const webAppJsonLd = {
  ...
  description:
    "Crop your e-Aadhar card PDF or image online for free. Adjust and crop the front and back sides to standard ID dimensions ready for print.",
...
const STEPS = [
  {
    icon: Upload,
    title: "Upload E-Aadhar PDF",
    desc: "Select your e-Aadhar PDF or image. Everything is processed entirely in your browser — your Aadhar data never leaves your device.",
  },
  {
    icon: Crop,
    title: "Crop Front & Back",
    desc: "Use the visual cropper to select the front side of your Aadhar card, then the back side. Zoom and adjust for a perfect crop.",
  },
  {
    icon: Download,
    title: "Download Print-Ready PDF",
    desc: "Download an A4 PDF with both sides formatted to standard ID card dimensions — ready for high-quality printing.",
  },
];
...
const RELATED = [
  ...
  },
  {
    ...
    title: "Protect PDF",
    description:
      "Encrypt your PDF with a password to keep sensitive documents secure.",
    icon: Lock,
  ...
  },
  {
    ...
    title: "E-Sign PDF",
    description:
      "Draw or type your signature and place it anywhere on a PDF instantly.",
    icon: PenLine,
        ...
        <section className="mt-20 border-t border-slate-200 dark:border-slate-800 pt-16 max-w-7xl mx-auto text-left">
          <div className="mb-16 text-center relative">
            ...
            <p className="text-base sm:text-lg text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed">
              Format your e-Aadhar PDF front and back panels to precise Indian
              ID card print-ready sizes. The entire process runs 100% inside
              your local browser memory so your personal data is always
              protected.
            </p>
          </div>
            ...
            <div className="bg-gradient-to-tr from-white to-slate-50/50 dark:from-slate-900 dark:to-slate-900/30 p-8 sm:p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-500 dark:text-slate-400 leading-relaxed font-medium text-sm">
                  ...
                  It automatically merges both sides side-by-side onto a
                  standard A4 sheet in official Indian ID dimensions, prepared
                  for instant high-quality printing.
                </p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-gradient-to-br from-white to-slate-50/30 dark:from-slate-900 dark:to-slate-900/50 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col gap-4 group">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed font-medium">
                    ...
                    information, our tool operates entirely client-side. No
