...
export const metadata: Metadata = {
  title: "Flipkart Label Cropper Online Free | Auto Crop & Sort",
  description: "Crop Flipkart shipping label PDFs online for free. Automatically extract clean labels with E-kart logistics anchors, reorder by SKU/Quantity, and download printable PDFs or PNGs.",
  keywords: "flipkart cropper, crop flipkart labels, flipkart label cropper online, split flipkart shipping labels, e-kart logistics crop, crop pdf online",
  alternates: {
    canonical: `${siteUrl}/tool/flipkart-cropper`,
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${siteUrl}/img/flipkart-cropper-og.png`,
        width: 1200,
        height: 630,
        alt: "Flipkart Label Cropper Online Free - SmartPDFs Plus",
      },
    ],
  },
  twitter: {
    ...
    title: "Flipkart Label Cropper Online Free | Auto Crop & Sort",
    description: "Crop Flipkart shipping label PDFs online for free. Automatically extract clean labels with E-kart logistics anchors, reorder by SKU/Quantity, and download printable PDFs or PNGs.",
    images: [`${siteUrl}/img/flipkart-cropper-og.png`],
  },
};
    ...
    <main className="min-h-screen bg-slate-50/50 dark:bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 sm:pt-12 pb-16">
        ...
        <nav aria-label="Breadcrumb" className="mb-6 flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500">
          ...
          <span aria-hidden="true">/</span>
          <span className="text-slate-600 dark:text-slate-300" aria-current="page">Flipkart Cropper</span>
        </nav>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {STEPS.map((s, i) => (
                <div key={i} className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm border border-slate-100 dark:border-slate-700 text-center">
                  <div className="inline-flex p-4 rounded-2xl mb-4 text-white animate-bounce" style={{ background: `${ACCENT}22`, color: ACCENT }}>
                    <s.icon size={28} />
                  </div>
        ...
        <section className="mt-20 border-t border-slate-200 dark:border-slate-800 pt-16 max-w-7xl mx-auto text-left">
          ...
          <div className="mb-16 text-center relative">
            ...
            <p className="text-base sm:text-lg text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed">
              Extract clean AWB shipping labels from your Flipkart PDF sheets without invoice spill or details. Sort sheets by quantity, SKU, or tracking ID automatically.
            </p>
          </div>
          ...
          <article className="space-y-16">
            ...
            <div className="bg-gradient-to-tr from-white to-slate-50/50 dark:from-slate-900 dark:to-slate-900/30 p-8 sm:p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed font-medium text-sm sm:text-base">
                  When fulfilling orders on Flipkart, the downloaded PDF sheets bundle customer delivery details together with extra payment records and invoices. Standard sticky labels need to exclude these billing segments. The Flipkart Label Cropper scans page layouts for coordinates like 'E-kart Logistics' and crops the clean sticker layout perfectly.
                </p>
                <p className="text-slate-500 dark:text-slate-400 leading-relaxed font-medium text-sm">
                  Our tool processes all files <strong className="text-orange-500 font-black">locally inside your browser engine</strong>. Your files are not uploaded to servers, ensuring maximum security and absolute privacy for your business.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-8 sm:p-12 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 relative">
                ...
                {[
                  { step: "01", title: "Select PDFs", desc: "Drag and drop your Flipkart label PDFs into the crop workspace." },
                  { step: "02", title: "Sort & Highlight", desc: "Configure settings to sort by SKU/Quantity and highlight bulk orders." },
                  { step: "03", title: "Print PDF", desc: "Click Start Extraction to build the clean PDF. Download and print." }
                ].map((s, idx) => (
