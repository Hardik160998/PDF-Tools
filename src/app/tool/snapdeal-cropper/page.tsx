...
const RELATED = [
  ...
  { id: 'amazon-cropper',   title: 'Amazon Label Cropper',   description: 'Extract Amazon shipping labels and automatically remove invoice pages.', icon: ShoppingBag, gradient: 'linear-gradient(135deg, #f26522, #f59e0b)', shadow: 'rgba(242,101,34,0.3)',  tag: 'Ecommerce', href: '/tool/amazon-cropper' },
