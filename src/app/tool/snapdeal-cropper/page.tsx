...
export const metadata: Metadata = {
  ...
  description:
    "Crop Snapdeal shipping label PDFs online for free. Automatically detects outer borders, highlights barcodes, quantities & addresses. 100% private in-browser tool.",
  keywords:
    "snapdeal cropper, crop snapdeal labels, snapdeal label cropper free, border detection label crop, thermal label cropper, smartpdfs",
  alternates: {
...
const RELATED = [
  ...
  },
  {
    ...
    description:
      "Extract Amazon shipping labels and automatically remove invoice pages.",
    icon: ShoppingBag,
