...
import { ImageIcon, Upload, Eye, Download, Type, FileJson, FileText, Combine, Scissors, CheckCircle } from 'lucide-react';
...
const FEATURES = ['Converts every page to JPG','High-quality 2x resolution','Download individually or as ZIP','Preview before downloading','No file size limits','100% private — runs in browser'];
const STEPS = [
