...
export const metadata: Metadata = {
  ...
  description: 'Convert PDF files to high-quality JPG images online for free. Extract images or convert entire PDF pages to JPG locally and securely in your browser.',
  keywords: 'pdf to jpg, convert pdf to jpg, pdf to image, extract images from pdf, free pdf converter, secure pdf to jpg, pdf to jpg offline, smartpdfs',
  alternates: {
...
const RELATED = [
  ...
  { id: 'jpg-to-pdf', title: 'JPG to PDF', description: 'Convert images like JPG, PNG, and TIFF into a PDF document.', icon: ImageIcon, gradient: 'linear-gradient(135deg, #eab308, #a16207)', shadow: 'rgba(234,179,8,0.3)', tag: 'Convert' },
...
function Breadcrumb() {
  return (
    <nav aria-label="Breadcrumb" className="mb-6 flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500">
      ...
      <span aria-hidden="true">/</span>
      <span className="text-slate-600 dark:text-slate-300" aria-current="page">PDF to JPG</span>
    </nav>
  );
}
  ...
  return (
    <main className="min-h-screen bg-slate-50/50 dark:bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 sm:pt-12 pb-16">
        ...
        <section aria-label="PDF to JPG Converter Application" className="mb-16">
        ...
        <section className="mt-20 border-t border-slate-200 dark:border-slate-800 pt-16 max-w-7xl mx-auto text-left">
          <div className="mb-16 text-center relative">
            ...
            <p className="text-base sm:text-lg text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed">
              Convert PDF pages into high-quality JPG image files in seconds. Extract images with total privacy—all file rendering happens locally on your computer.
            </p>
          </div>
          ...
          <article className="space-y-16">
            ...
            <div className="bg-gradient-to-tr from-white to-slate-50/50 dark:from-slate-900 dark:to-slate-900/30 p-8 sm:p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed font-medium text-sm sm:text-base">
                  Converting PDF to JPG allows you to turn pages of a PDF document into standard JPEG image files. This makes it easy to share pages on social platforms, use them in presentations, or view them without a PDF reader.
                </p>
                <p className="text-slate-500 dark:text-slate-400 leading-relaxed font-medium text-sm">
                  With SmartPDFs, this conversion process runs <strong className="text-yellow-600 dark:text-yellow-400 font-black">entirely in your local browser sandbox</strong>. Since your files are never uploaded to any server, your sensitive data is 100% safe. This client-side approach ensures instantaneous processing times with absolutely zero file queues.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-8 sm:p-12 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 relative">
                ...
                {[
                  { step: "01", title: "Select PDF", desc: "Drag and drop your PDF file or click 'Choose File' to select it from your device." },
                  { step: "02", title: "Adjust Quality", desc: "Configure settings such as image rendering density (DPI) to get the exact output detail you need." },
                  { step: "03", title: "Convert & Download", desc: "Click 'Convert' and save your generated JPG files. Multi-page PDFs are saved as a neat ZIP archive." }
                ].map((s, idx) => (
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-gradient-to-br from-white to-slate-50/30 dark:from-slate-900 dark:to-slate-900/50 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col gap-4 group">
                  ...
                  <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight group-hover:text-green-500 transition-colors">100% Client-Side Security</h3>
                  <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed font-medium">
                    Your files never reach any server. PDF-to-image conversion happens within your browser using client-side WebAssembly, ensuring high-speed processing without compromising your document's privacy.
                  </p>
                </div>
                <div className="bg-gradient-to-br from-white to-slate-50/30 dark:from-slate-900 dark:to-slate-900/50 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col gap-4 group">
                  ...
                  <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight group-hover:text-yellow-500 transition-colors">Batch Processing & High Quality</h3>
                  <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed font-medium">
                    Whether your PDF has one page or one hundred, our batch processing lets you export them in one click. Our parser ensures layouts, vectors, and font graphics are preserved cleanly.
                  </p>
                </div>
              </div>
