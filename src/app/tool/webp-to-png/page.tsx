...
export const metadata: Metadata = {
  ...
  description:
    "Convert WebP images to PNG format online for free. Restore lossless editing capabilities and full compatibility instantly. 100% private in-browser conversion.",
  keywords:
    "webp to png, convert webp to png, webp to png converter, free webp to png, convert image to png, online png converter, local image conversion, smartpdfs",
  alternates: {
