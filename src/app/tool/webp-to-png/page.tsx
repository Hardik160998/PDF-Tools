...
export default function WebpToPngPage() {
 ...
 <h3 className="text-base sm:text-base font-bold text-slate-800 dark:text-white uppercase tracking-tight group-hover:text-teal-500 transition-colors pr-4">
 {item.q}
 </h3>
