      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 sm:pt-12 pb-16">
        ...
        <section className="mb-20 text-left mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto mb-12">
            {/* Blog Post 1: Meesho Cropper Guide */}
            <a href="/blog/how-to-crop-meesho-labels" className="group bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-lg transition-all overflow-hidden flex flex-col h-full">
                <div className="p-6 flex flex-col flex-1 gap-3">
                    <div className="flex items-start gap-3">
                        <div className="w-8 h-8 bg-[#ec4899] rounded-lg flex items-center justify-center text-white shrink-0 mt-0.5">
                        ...
                        <h3 className="font-bold text-slate-800 text-[17px] leading-snug group-hover:text-red-600 transition-colors">
                            How to Crop Meesho Labels Online Free (Ultimate Guide)
                        </h3>
                    </div>
            ...
            {/* Blog Post 5: Warehouse Automation Tips */}
