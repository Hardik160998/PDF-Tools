...
export const metadata: Metadata = {
  ...
  description:
    "Crop Meesho shipping label PDFs online for free to keep only the shipping address, return details & barcodes. Automatically removes the TAX INVOICE section completely.",
  keywords:
    "meshocrop, crop meesho label without invoice, meesho label cropper, remove tax invoice meesho, split meesho pdf, label cropper 2x2 grid",
  alternates: {
        ...
        <section className="mt-20 border-t border-slate-200 dark:border-slate-800 pt-16 max-w-7xl mx-auto text-left">
          <div className="mb-16 text-center relative">
            ...
            <p className="text-base sm:text-lg text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed">
              Quickly strip the invoice layout from your downloads. Generate
              pure shipping labels and output them in standard grids or single
              sheets for instant printing.
            </p>
          </div>
            ...
            <div className="bg-gradient-to-tr from-white to-slate-50/50 dark:from-slate-900 dark:to-slate-900/30 p-8 sm:p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed font-medium text-sm sm:text-base">
                  Normally, Meesho downloads bundle the customer shipping
                  details together with detailed tax invoice sheets. For compact
                  thermal printing, or to print multiple labels on a single A4
                  sticker sheet in a 2x2 grid, you need to extract only the
                  address barcode sections. This cropper tool searches the PDF
                  vectors for the TAX INVOICE header, crops everything below it,
                  and exports clean logistics templates.
                </p>
