...
import { 
  ...
  ImageIcon, Lock, Shield, Zap, Globe, Info, ArrowRight, Star, Check, 
...
export const metadata: Metadata = {
  ...
  description: 'Convert Microsoft Word (DOCX or DOC) documents to high-quality PDF files online for free. Complete formatting, fonts, and images preservation.',
  keywords: 'docx to pdf, word to pdf, convert word to pdf, doc to pdf, convert docx to pdf, free word to pdf converter, online docx to pdf, smartpdfs plus',
  alternates: {
    canonical: `${siteUrl}/tool/docx-to-pdf`,
  },
  robots: {
    index: true,
    follow: true,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Word to PDF Converter Online - SmartPDFs Plus',
      },
    ],
  },
  twitter: {
...
function Breadcrumb() {
  return (
    <nav aria-label="Breadcrumb" className="mb-6 flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500">
      ...
      <span aria-hidden="true">/</span>
      <span className="text-slate-600 dark:text-slate-300" aria-current="page">DOCX to PDF</span>
    </nav>
  );
}
    ...
    <main className="min-h-screen bg-slate-50/50 dark:bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 sm:pt-12 pb-16">
        ...
        <section aria-label="Tool Benefits Quick Overview" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-20 animate-fade-in">
          {[
            { title: 'Lightning Fast', desc: 'Convert DOCX to PDF in seconds using our optimized cloud engine — no waiting, no queue.', icon: Zap },
            ...
            { title: 'Perfect Fidelity', desc: 'Fonts, tables, images, headers, footers, and styles are all preserved in the output PDF.', icon: FileText },
            ...
            <div key={i} className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-xl transition-all group text-center flex flex-col items-center gap-3">
              <div className="inline-flex p-4 rounded-2xl bg-blue-50 dark:bg-blue-500/10 text-blue-500 group-hover:scale-110 transition-transform"><item.icon size={26} /></div>
        ...
        <section className="mt-20 border-t border-slate-200 dark:border-slate-800 pt-16 max-w-7xl mx-auto text-left">
          ...
          <div className="mb-16 text-center relative">
            ...
            <p className="text-base sm:text-lg text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed">
              Transform Microsoft Word files (.docx or .doc) into high-fidelity PDF documents in a single click. Keep layouts, margins, tables, and images perfectly preserved.
            </p>
          </div>
          ...
          <article className="space-y-16">
            ...
            <div className="bg-gradient-to-tr from-white to-slate-50/50 dark:from-slate-900 dark:to-slate-900/30 p-8 sm:p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed font-medium text-sm sm:text-base">
                  Converting DOCX to PDF is the process of building a read-only, layout-stable document from editable Microsoft Word documents. When you share Word files, formatting changes depending on font availability and OS versions. Converting to PDF guarantees that your document looks identical on every desktop or mobile screen.
                </p>
                <p className="text-slate-500 dark:text-slate-400 leading-relaxed font-medium text-sm">
                  SmartPDFs Plus processes your documents using advanced cloud engine logic, converting inline shapes, image positions, page margins, and fonts securely over HTTPS. All file uploads are <strong className="text-blue-500 font-black">permanently wiped within 1 hour</strong> to ensure total confidentiality.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-8 sm:p-12 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 relative">
                ...
                {[
                  { step: "01", title: "Upload Word File", desc: "Drag and drop your DOCX or DOC file, or select it directly using the file picker above." },
                  { step: "02", title: "Process Document", desc: "Our layout parser converts document elements, tables, and spacing into PDF code instantly." },
                  { step: "03", title: "Download PDF Output", desc: "Download your clean, watermark-free PDF. Uploaded files are automatically wiped after 1 hour." }
                ].map((s, idx) => (
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-gradient-to-br from-white to-slate-50/30 dark:from-slate-900 dark:to-slate-900/50 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col gap-4 group">
                  ...
                  <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight group-hover:text-green-500 transition-colors">Total Server Security</h3>
                ...
                <div className="bg-gradient-to-br from-white to-slate-50/30 dark:from-slate-900 dark:to-slate-900/50 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col gap-4 group">
                  ...
                  <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight group-hover:text-blue-500 transition-colors">Layout & Formatting Integrity</h3>
                  <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed font-medium">
                    Our layout parser supports advanced typography, embedded graphics, margins, page numbers, list elements, and footnotes, preventing structural breaking during conversion.
                  </p>
                </div>
              </div>
