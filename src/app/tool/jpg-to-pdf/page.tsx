...
import { ImageIcon, Upload, SlidersHorizontal, Download, Type, FileText, Combine, Scissors, Zap, Lock, CheckCircle } from 'lucide-react';
      ...
      <section className="pt-16 pb-8 text-center">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-yellow-50 text-yellow-600 border border-yellow-100 text-xs font-black uppercase tracking-widest shadow-sm mb-6">
            <ImageIcon size={13} /> Free JPG to PDF Tool
          </div>
          <h1 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tight leading-tight mb-5">
            Convert JPG to PDF{' '}
            <span style={{ background: 'linear-gradient(135deg, #eab308, #a16207)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>In Seconds</span>
          </h1>
          <p className="text-lg text-slate-500 font-medium leading-relaxed max-w-2xl mx-auto mb-8">
            Turn one or multiple JPG or PNG images into a single PDF document. Each image becomes its own page — perfect for sharing, printing, or archiving photos.
          </p>
