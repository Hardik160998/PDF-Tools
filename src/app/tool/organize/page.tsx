...
const STEPS = [
  { icon: Upload,     title: 'Upload Your PDF', desc: 'Select one or more PDF files. All pages load instantly as visual thumbnails — no waiting.' },
  { icon: LayoutGrid, title: 'Arrange Pages',   desc: "Drag and drop pages into any order. Rotate or delete pages you don't need with one click." },
  { icon: Download,   title: 'Download Result', desc: 'Click "Organize PDF" and download your perfectly arranged document in seconds.' },
];
...
function RelatedToolsShimmer({ heading }: { heading: string }) {
  return (
...
export default function OrganizePage() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #fff7ed33 0%, #fff0 50%, #fef3c733 100%)' }}>
      ...
      <section className="pt-16 pb-8 text-center">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tight leading-tight mb-5">
            Organize PDF Pages{' '}
            <span style={{ background: 'linear-gradient(135deg, #f26522, #f59e0b)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Visually</span>
          </h1>
      ...
      {/* RELATED TOOLS */}
      {!mounted ? <RelatedToolsShimmer heading="More Organize & Convert Tools" /> : (
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-5xl">
