...
import { 
  LayoutGrid, FileText, ArrowUpDown, 
...
export const metadata: Metadata = {
  title: 'Organize PDF Pages Free - Visual PDF Page Reorder & Rotate | SmartPDFs',
  description: 'Organize PDF pages online for free. Visual drag and drop to reorder, delete, rotate, or add pages. 100% secure local browser processing, zero uploads.',
  keywords: 'organize pdf, reorder pdf pages, rotate pdf pages online, sort pdf pages, visual pdf organizer, delete pdf pages, merge and organize pdf, free pdf tool',
  alternates: {
  ...
  openGraph: {
    type: 'website',
    title: 'Organize PDF Pages Free - Visual PDF Page Reorder & Rotate | SmartPDFs',
    description: 'Organize PDF pages online for free. Visual drag and drop to reorder, delete, rotate, or add pages. 100% secure local browser processing.',
    siteName: 'SmartPDFs',
        ...
        <article className="space-y-16 max-w-7xl mx-auto mt-20">
          ...
          <section className="text-center max-w-4xl mx-auto space-y-4">
            ...
            <p className="text-lg font-medium text-slate-500 dark:text-slate-400 leading-relaxed">
              Arrange pages, rotate vertical pages to horizontal, and remove extra pages from your PDF documents. Keep your files neat and customized with our visual page organizer, processed completely locally in your browser.
            </p>
          </section>
          ...
          <section className="bg-gradient-to-tr from-white to-orange-50/20 dark:from-slate-900 dark:to-slate-950 p-8 sm:p-12 rounded-[2.5rem] border border-orange-100/50 dark:border-slate-800/80 space-y-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: "No Server Uploads", desc: "Files run directly via WebAssembly in your browser. No internet transfer, no cloud leakage." },
                { title: "Real-Time Visuals", desc: "High-resolution page thumbnails let you see exactly what page you are moving." },
                { title: "Rotate & Crop Alignment", desc: "Align pages properly. Rotate vertical scans to matches the standard horizontal flow." },
                { title: "Multi-Source Merge", desc: "Add more files seamlessly. Drag and order pages from different documents easily." }
              ].map((feat, i) => (
          ...
          <section className="space-y-8 max-w-4xl mx-auto">
            <div className="text-center space-y-2">
              ...
              <p className="text-sm font-medium text-slate-400 uppercase tracking-wider">Organize PDF FAQs</p>
            </div>
          ...
          <section className="pt-10 border-t border-slate-100 dark:border-slate-800/80">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { name: "Compare PDF", path: "/tool/compare-pdf", desc: "Visual side-by-side diff" },
