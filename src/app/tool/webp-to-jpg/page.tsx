...
export const metadata: Metadata = {
  ...
  description:
    "Convert WebP images to JPG format online for free. Convert modern WebP files into universally compatible JPGs instantly. 100% secure client-side browser processing.",
  keywords:
    "webp to jpg, convert webp to jpg, webp to jpeg converter, free webp to jpg, convert image to jpg, online webp converter, local image conversion, smartpdfs",
  alternates: {
