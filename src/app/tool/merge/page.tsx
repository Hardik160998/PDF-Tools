...
const STEPS = [
  {
    ...
    desc: 'Select two or more PDF files from your device. Add as many as you need — no limits.',
  },
  {
    icon: GripVertical,
    title: 'Reorder Files',
    desc: 'Drag and drop files into the exact order you want them to appear in the final PDF.',
  },
  {
    icon: Download,
    title: 'Download Merged PDF',
    desc: 'Click "Merge PDF" and download your combined document instantly — one clean file.',
  },
];
...
const RELATED_TOOLS = [
  ...
  },
  {
    id: 'protect',
    title: 'Protect PDF',
    description: 'Encrypt your merged PDF with a password to keep it secure.',
    icon: Lock,
