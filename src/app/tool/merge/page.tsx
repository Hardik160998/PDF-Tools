...
export default function MergePage() {
 ...
 <div className="text-white font-bold" aria-hidden="true">{i + 1}</div>
 </div>
 ...
 Unlike conventional online services that require you to upload private files to external servers (exposing your sensitive data to security risks), SmartPDFs Plus combines your files <strong className="text-orange-500 font-bold">100% locally in your web browser</strong> using native Client-side WebAssembly logic. Your files never touch our servers, guaranteeing complete privacy and instant processing.
 </p>
 </div>
 </div>
 ...
 <h3 className="text-lg font-bold text-slate-900 dark:text-white uppercase tracking-tight">{s.title}</h3>
 ...
 <h3 className="text-xl font-bold text-slate-900 dark:text-white uppercase tracking-tight group-hover:text-green-500 transition-colors">100% Client-Side Privacy</h3>
 ...
 <h3 className="text-xl font-bold text-slate-900 dark:text-white uppercase tracking-tight group-hover:text-orange-500 transition-colors">No Watermarks & Instant Execution</h3>
 <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed font-medium">
 ...
 <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400 bg-slate-50 dark:bg-slate-800 px-2 py-1 rounded-full border border-slate-100 dark:border-slate-700">{t.tag}</span>
 </div>
 <div>
 <h3 className="text-base font-bold text-slate-900 dark:text-white mb-1 group-hover:text-orange-500 transition-colors">{t.title}</h3>
