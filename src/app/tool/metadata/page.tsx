...
function EditToolsSkeleton() {
 ...
 {/* Dynamic SEO Schemas */}
 {(() => {
 const meta = getToolMeta('metadata');
 return meta ? (
 <>
 <WebAppSchema name={`${meta.title} – Free Online Tool`} description={meta.description} url={getToolUrl('metadata')} />
 {meta.faqs.length > 0 && <FAQSchema faqs={meta.faqs} />}
 <BreadcrumbSchema items={[{ label: 'Tools', href: '/#tools' }, { label: meta.title, href: `/tool/metadata` }]} />
 </>
 ) : null;
 })()}
...
export default function MetadataPage() {
 ...
 {/* Interactive Metadata Editor Tool */}
 <section aria-label="PDF Metadata Editor Application" className="mb-16">
 ...
 {/* What is PDF Metadata Card */}
 <div className="bg-gradient-to-tr from-white to-slate-50/50 dark:from-slate-900 dark:to-slate-900/30 p-8 sm:p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col md:flex-row gap-8 items-start">
 <div className="p-4 rounded-2xl bg-slate-500/10 text-slate-600 shrink-0">
 <Info size={32} />
 </div>
 ...
 >
 <div className="w-12 h-12 rounded-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center text-lg font-bold text-slate-500 border-2 border-slate-100 dark:border-slate-800 shadow-sm group-hover:scale-110 group-hover:border-slate-500/40 transition-all duration-300">
 {s.step}
 </div>
 ...
 <h3 className="text-xl font-bold text-slate-900 dark:text-white uppercase tracking-tight group-hover:text-slate-650 transition-colors">
 ...
 >
 <summary className="flex items-center justify-between cursor-pointer list-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-500 rounded-lg">
 <h3 className="text-base sm:text-base font-bold text-slate-800 dark:text-white uppercase tracking-tight group-hover:text-slate-650 transition-colors pr-4">
 {item.q}
 </h3>
 <span className="shrink-0 transition-transform duration-300 group-open:rotate-180 text-slate-400 group-hover:text-slate-600">
 <ChevronDown size={18} />
 </span>
 </summary>
 ...
 <div>
 <h3 className="text-base font-bold text-slate-900 dark:text-white mb-1 group-hover:text-slate-650 transition-colors">
 {t.title}
 </h3>
