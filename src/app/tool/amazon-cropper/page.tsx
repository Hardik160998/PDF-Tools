...
export const metadata: Metadata = {
  ...
  description:
    "Crop Amazon shipping label PDFs online for free. Automatically remove invoice pages and arrange shipping labels in clean, print-ready layouts. 100% private in-browser tool.",
  keywords:
    "amazon cropper, crop amazon shipping labels, amazon label cropper online, remove amazon invoice pages, split amazon label pdf, thermal label cropper, smartpdfs",
  alternates: {
