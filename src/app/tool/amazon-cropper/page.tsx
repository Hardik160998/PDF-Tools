...
import {
  ShoppingBag, CheckCircle2, ShieldCheck, Zap, Crop, Combine, Info, ArrowRight, HelpCircle, ChevronDown, Star, Check
} from "lucide-react";
...
export const metadata: Metadata = {
  title: "Amazon Label Cropper Online Free | Auto Crop & Sort | SmartPDFs",
  description: "Crop Amazon shipping label PDFs online for free. Automatically remove invoice pages and arrange shipping labels in clean, print-ready layouts. 100% private in-browser tool.",
  keywords: "amazon cropper, crop amazon shipping labels, amazon label cropper online, remove amazon invoice pages, split amazon label pdf, thermal label cropper, smartpdfs",
  alternates: {
    canonical: `${siteUrl}/tool/amazon-cropper`,
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${siteUrl}/img/amazon-cropper-og.png`,
        width: 1200,
        height: 630,
        alt: "Amazon Label Cropper Free - SmartPDFs Plus",
      },
    ],
  },
  twitter: {
    ...
    title: "Amazon Label Cropper Online Free | Auto Crop & Sort | SmartPDFs",
    description: "Crop Amazon shipping label PDFs online for free. Automatically remove invoice pages and arrange shipping labels in clean, print-ready layouts. 100% private in-browser tool.",
    images: [`${siteUrl}/img/amazon-cropper-og.png`],
  },
};
...
const webAppJsonLd = {
  ...
  "description": "Crop Amazon shipping label PDFs online for free. Automatically detect and remove even-numbered invoice pages, and arrange labels in 4-per-page layouts.",
...
const RELATED_TOOLS = [
  ...
  { id: 'snapdeal-cropper', title: 'Snapdeal Label Cropper', description: 'Smart border detection to crop Snapdeal shipping labels perfectly.', icon: ShoppingBag, gradient: 'linear-gradient(135deg, #e40046, #f59e0b)', shadow: 'rgba(228,0,70,0.3)', tag: 'Ecommerce', href: '/tool/snapdeal-cropper' },
    ...
    <main className="min-h-screen bg-slate-50/50 dark:bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 sm:pt-12 pb-16">
        ...
        <nav aria-label="Breadcrumb" className="mb-6 flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500">
          ...
          <span aria-hidden="true">/</span>
          <span className="text-slate-600 dark:text-slate-300" aria-current="page">Amazon Cropper</span>
        </nav>
        ...
        {/* Feature Grid */}
        <section aria-label="Tool Features" className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 mb-20">
          {[
        ...
        {/* Guidelines */}
        <section aria-label="Guidelines and Guide" className="bg-[#FF9900]/5 dark:bg-[#FF9900]/10 border border-[#FF9900]/20 rounded-3xl p-8 sm:p-12 mb-20">
        ...
        <section className="mt-20 border-t border-slate-200 dark:border-slate-800 pt-16 max-w-7xl mx-auto text-left">
          ...
          <div className="mb-16 text-center relative">
            ...
            <p className="text-base sm:text-lg text-slate-500 dark:text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed">
              Instantly extract shipping label pages from Amazon seller PDF print sheets. Detect and clear billing/invoice pages automatically without cloud servers.
            </p>
          </div>
          ...
          <article className="space-y-16">
            ...
            <div className="bg-gradient-to-tr from-white to-slate-50/50 dark:from-slate-900 dark:to-slate-900/30 p-8 sm:p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed font-medium text-sm sm:text-base">
                  Amazon downloads generate mixed PDF streams containing shipping labels (AWB tracking details) and billing pages. Printing these on a label roll results in wasted paper rolls. The Amazon Label Cropper checks text anchors such as "Sold on" and "ATSPL", detects page sequences, and deletes unnecessary invoice documents automatically.
                </p>
                <p className="text-slate-500 dark:text-slate-400 leading-relaxed font-medium text-sm">
                  Our algorithm runs <strong className="text-orange-500 font-black">100% locally inside your web browser sandbox</strong>. Since no file bytes are sent to cloud storage, your buyer credentials and delivery details remain absolutely secure.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-8 sm:p-12 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 relative">
                ...
                {[
                  { step: "01", title: "Select PDFs", desc: "Drag and drop your Amazon PDF sheets into the crop area." },
                  { step: "02", title: "Smart Auto-Clear", desc: "The engine automatically separates labels and deletes invoice pages." },
                  { step: "03", title: "Download PDF", desc: "Click Crop PDF. Download your clean thermal-aligned files instantly." }
                ].map((s, idx) => (
