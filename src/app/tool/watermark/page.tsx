...
export default function WatermarkPage() {
  ...
  <span className="p-1.5 rounded-full bg-purple-500/10 text-purple-500 shrink-0">
    <HelpCircle size={18} />
  </span>
  <h3 className="text-base sm:text-base font-bold text-slate-800 dark:text-white uppercase tracking-tight group-hover:text-purple-500 transition-colors">
                        {item.q}
                      </h3>
</div>
