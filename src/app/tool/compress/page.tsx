...
const STEPS = [
  {
    ...
    desc: 'Select any PDF file from your device. Large files are handled entirely in your browser — nothing is uploaded.',
  },
  {
    icon: Settings,
    title: 'Auto Compress',
    desc: 'Our tool strips metadata, optimises object streams, and removes redundant data to shrink the file size.',
  },
  {
    icon: Download,
    title: 'Download Compressed PDF',
    desc: 'See the before/after size comparison, then download your smaller PDF with one click.',
  },
];
...
const RELATED_TOOLS = [
  ...
  },
  {
    id: 'organize',
    title: 'Organize PDF',
    description: 'Reorder, rotate, and delete pages visually with drag-and-drop ease.',
    icon: LayoutGrid,
    gradient: 'linear-gradient(135deg, #f26522, #c2410c)',
    shadow: 'rgba(242,101,34,0.3)',
    tag: 'Organize',
  },
  {
    id: 'repair-pdf',
    title: 'Repair PDF',
    description: 'Recover data from damaged, corrupted or illegible PDF files.',
    icon: Zap,
  ...
  },
  {
    id: 'protect',
    title: 'Protect PDF',
    description: 'Encrypt your compressed PDF with a password to keep it secure.',
    icon: Lock,
      ...
      <section className="pt-16 pb-8 text-center">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-50 text-green-600 border border-green-100 text-xs font-black uppercase tracking-widest shadow-sm mb-6">
            <Zap size={13} /> Free PDF Compressor Tool
          </div>
          ...
          <p className="text-lg text-slate-500 font-medium leading-relaxed max-w-2xl mx-auto mb-8">
            Reduce your PDF file size in seconds. Our compressor strips hidden metadata and optimises object streams — keeping text sharp and content intact.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {STEPS.map((step, i) => (
              <div key={i} className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 text-center">
                <div className="inline-flex p-4 rounded-2xl bg-green-50 text-green-500 mb-4">
                  <step.icon size={28} />
                </div>
