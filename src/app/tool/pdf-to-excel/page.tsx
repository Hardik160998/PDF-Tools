...
import { FileSpreadsheet, Upload, Sparkles, Download, FileText, Presentation, Globe, Type, Lock, Zap, CheckCircle } from 'lucide-react';
...
const FEATURES = [
  'Extracts tables to XLSX',
  'Preserves rows & columns',
      ...
      <section className="pt-16 pb-8 text-center">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-50 text-green-600 border border-green-100 text-xs font-black uppercase tracking-widest shadow-sm mb-6">
            <FileSpreadsheet size={13} /> Free PDF to Excel Tool
          </div>
          <h1 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tight leading-tight mb-5">
            Convert PDF to Excel{' '}
            <span style={{ background: 'linear-gradient(135deg, #22c55e, #15803d)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Editable XLSX</span>
          </h1>
          <p className="text-lg text-slate-500 font-medium leading-relaxed max-w-2xl mx-auto mb-8">
            Extract tables and data from any PDF into a fully editable Excel spreadsheet. Rows, columns, and cell data are preserved with high accuracy.
          </p>
