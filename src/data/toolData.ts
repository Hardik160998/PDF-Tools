...
export const TOOL_META_MAP: Record<string, ToolMeta> = {
    ...
    'add-blank-page': {
        slug: 'add-blank-page',
        title: 'Add Blank Page to PDF Online',
    ...
    'pdf-to-docx': {
        slug: 'pdf-to-docx',
        title: 'PDF to DOCX Converter Free',
    ...
    'docx-to-pdf': {
        slug: 'docx-to-pdf',
        title: 'DOCX to PDF Converter Free',
    ...
    'excel-to-pdf': {
        slug: 'excel-to-pdf',
        title: 'Excel to PDF Converter Free',
    ...
    'pdf-to-excel': {
        slug: 'pdf-to-excel',
        title: 'PDF to Excel Converter Free',
    ...
    'ppt-to-pdf': {
        slug: 'ppt-to-pdf',
        title: 'PPT to PDF Converter Free',
    ...
    'pdf-to-ppt': {
        slug: 'pdf-to-ppt',
        title: 'PDF to PPT Converter Free',
    ...
    'html-to-pdf': {
        slug: 'html-to-pdf',
        title: 'HTML to PDF Converter Free',
    ...
    'webpage-to-pdf': {
        slug: 'webpage-to-pdf',
        title: 'Webpage to PDF Converter Free',
    ...
    'pdf-to-xml': {
        slug: 'pdf-to-xml',
        title: 'PDF to XML Converter Free',
    ...
    'jpg-to-webp': { slug: 'jpg-to-webp', title: 'JPG to WebP Converter Free', description: 'Convert JPG images to WebP format online for free. Get smaller, faster web images.', keywords: 'jpg to webp, jpeg to webp, convert jpg to webp', faqs: [{ question: 'Why convert to WebP?', answer: 'WebP is a modern image format that provides better compression than JPEG and PNG with similar quality.' }] },
    'webp-to-jpg': { slug: 'webp-to-jpg', title: 'WebP to JPG Converter Free', description: 'Convert WebP images to JPG format online for free. Turn WebP into a universally supported JPEG.', keywords: 'webp to jpg, webp to jpeg, convert webp to jpg', faqs: [{ question: 'Why convert WebP to JPG?', answer: 'JPG has broader compatibility with older software and devices that do not support WebP.' }] },
    'png-to-webp': { slug: 'png-to-webp', title: 'PNG to WebP Converter Free', description: 'Convert PNG images to WebP format online for free. Optimize PNGs for the web.', keywords: 'png to webp, convert png to webp, image optimizer', faqs: [] },
    'webp-to-png': { slug: 'webp-to-png', title: 'WebP to PNG Converter Free', description: 'Convert WebP images to PNG format online for free. Get a lossless PNG from any WebP file.', keywords: 'webp to png, convert webp to png', faqs: [] },
    'jpg-to-avif': { slug: 'jpg-to-avif', title: 'JPG to AVIF Converter Free', description: 'Convert JPG images to AVIF format online for free. Get ultra-compressed, high-quality images.', keywords: 'jpg to avif, jpeg to avif, convert jpg to avif', faqs: [] },
    'avif-to-jpg': { slug: 'avif-to-jpg', title: 'AVIF to JPG Converter Free', description: 'Convert AVIF images to JPG format online for free. Turn AVIF into widely supported JPEG.', keywords: 'avif to jpg, avif to jpeg, convert avif to jpg', faqs: [] },
    'png-to-avif': { slug: 'png-to-avif', title: 'PNG to AVIF Converter Free', description: 'Convert PNG images to AVIF format online for free. Compress images with next-gen AVIF encoding.', keywords: 'png to avif, convert png to avif', faqs: [] },
    'avif-to-png': { slug: 'avif-to-png', title: 'AVIF to PNG Converter Free', description: 'Convert AVIF images to PNG format online for free. Get a lossless PNG from an AVIF file.', keywords: 'avif to png, convert avif to png', faqs: [] },
    'webp-to-avif': { slug: 'webp-to-avif', title: 'WebP to AVIF Converter Free', description: 'Convert WebP images to AVIF format online for free. Further compress your web images.', keywords: 'webp to avif, convert webp to avif', faqs: [] },
    'avif-to-webp': { slug: 'avif-to-webp', title: 'AVIF to WebP Converter Free', description: 'Convert AVIF images to WebP format online for free. Export AVIF as a compatible WebP file.', keywords: 'avif to webp, convert avif to webp', faqs: [] },
    ...
    'bookmark-pdf': {
        slug: 'bookmark-pdf',
        title: 'Add Bookmarks to PDF Online',
    ...
    'remove-ocr': {
        slug: 'remove-ocr',
        title: 'Remove OCR from PDF Online',
    ...
    'extract-text': {
        slug: 'extract-text',
        title: 'Extract Text from PDF Files Online',
    ...
    'aadhar-crop': {
        slug: 'aadhar-crop',
        title: 'Aadhar Card Cropper Online',
    ...
    'meesho-cropper': {
        slug: 'meesho-cropper',
        title: 'Meesho Label Cropper Online',
    ...
    'amazon-cropper': {
        slug: 'amazon-cropper',
        title: 'Amazon Label Cropper Online',
    ...
    'flipkart-cropper': {
        ...
        title: 'Flipkart Label Cropper Online',
    ...
    'snapdeal-cropper': {
        ...
        title: 'Snapdeal Label Cropper Online',
